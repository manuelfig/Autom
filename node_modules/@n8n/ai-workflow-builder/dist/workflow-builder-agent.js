...
exports.shouldModifyState = shouldModifyState;
...
const cleanup_dangling_tool_call_messages_1 = require("./utils/cleanup-dangling-tool-call-messages");
...
function shouldModifyState(state, autoCompactThresholdTokens) {
    ...
    const estimatedTokens = (0, token_usage_1.estimateTokenCountFromMessages)([
        ...messages,
        new messages_1.HumanMessage(workflowContextToAppend),
    ]);
...
function getWorkflowContext(state) {
    const trimmedWorkflow = (0, trim_workflow_context_1.trimWorkflowJSON)(state.workflowJSON);
...
class WorkflowBuilderAgent {
    ...
    createWorkflow() {
        ...
        const callModel = async (state) => {
            ...
            const userToolIndices = (0, helpers_1.findUserToolMessageIndices)(prompt.messages);
            (0, helpers_1.cleanStaleWorkflowContext)(prompt.messages, userToolIndices);
            (0, helpers_1.applyCacheControlMarkers)(prompt.messages, userToolIndices, workflowContext);
        ...
        const shouldModifyStateInternal = (state) => {
        ...
        const cleanupDanglingToolCalls = (state) => {
            const messagesToRemove = (0, cleanup_dangling_tool_call_messages_1.cleanupDanglingToolCallMessages)(state.messages);
