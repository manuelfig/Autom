...
export declare const LOG_SCOPES: readonly ["concurrency", "external-secrets", "license", "multi-main-setup", "pruning", "pubsub", "push", "redis", "scaling", "waiting-executions", "task-runner", "task-runner-js", "task-runner-py", "insights", "workflow-activation", "ssh-client", "data-table", "cron", "community-nodes", "legacy-sqlite-execution-recovery", "chat-hub", "breaking-changes"];
