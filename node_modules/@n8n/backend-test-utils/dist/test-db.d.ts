...
type EntityName = keyof typeof entities | 'InsightsRaw' | 'InsightsByPeriod' | 'InsightsMetadata' | 'DataTable' | 'DataTableColumn' | 'ChatHubSession' | 'ChatHubMessage' | 'OAuthClient' | 'AuthorizationCode' | 'AccessToken' | 'RefreshToken' | 'UserConsent';
