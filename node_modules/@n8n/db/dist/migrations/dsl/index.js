...
const createSchemaBuilder = (tablePrefix, queryRunner) => ({
    ...
    addForeignKey: (tableName, columnName, reference, customConstraintName, onDelete) => new table_1.AddForeignKey(tableName, columnName, reference, tablePrefix, queryRunner, customConstraintName, onDelete),
