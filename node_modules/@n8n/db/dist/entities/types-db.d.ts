...
declare const ALL_AUTH_PROVIDERS: z.ZodEnum<["ldap", "email", "saml", "oidc"]>;
export type AuthProviderType = z.infer<typeof ALL_AUTH_PROVIDERS>;
export declare function isAuthProviderType(value: string): value is AuthProviderType;
...
export type TestRunErrorCode = 'TEST_CASES_NOT_FOUND' | 'INTERRUPTED' | 'UNKNOWN_ERROR' | 'EVALUATION_TRIGGER_NOT_FOUND' | 'EVALUATION_TRIGGER_NOT_CONFIGURED' | 'EVALUATION_TRIGGER_DISABLED' | 'SET_OUTPUTS_NODE_NOT_CONFIGURED' | 'SET_METRICS_NODE_NOT_FOUND' | 'SET_METRICS_NODE_NOT_CONFIGURED' | 'CANT_FETCH_TEST_CASES';
export type TestCaseExecutionErrorCode = 'NO_METRICS_COLLECTED' | 'MOCKED_NODE_NOT_FOUND' | 'FAILED_TO_EXECUTE_WORKFLOW' | 'INVALID_METRICS' | 'UNKNOWN_ERROR';
