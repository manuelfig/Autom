...
class WorkflowDependencies {
    constructor(workflowId, workflowVersionId) {
...
let WorkflowDependencyRepository = class WorkflowDependencyRepository extends typeorm_1.Repository {
    ...
    async acquireLockAndCheckForExistingData(workflowId, tx) {
        if (this.databaseConfig.type === 'sqlite') {
            return await tx.existsBy(entities_1.WorkflowDependency, { workflowId });
        }
