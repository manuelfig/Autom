...
export declare class WorkflowRepository extends Repository<WorkflowEntity> {
    ...
    getMany(workflowIds: string[], options?: ListQuery.Options): Promise<(Pick<WorkflowEntity, "id"> & Partial<Pick<WorkflowEntity, "name" | "updatedAt" | "createdAt" | "description" | "tags" | "active" | "versionId">>)[]>;
    getManyAndCount(sharedWorkflowIds: string[], options?: ListQuery.Options): Promise<{
        workflows: (Pick<WorkflowEntity, "id"> & Partial<Pick<WorkflowEntity, "name" | "updatedAt" | "createdAt" | "description" | "tags" | "active" | "versionId">>)[] | ListQueryDb.Workflow.WithSharing[];
        count: number;
    }>;
    ...
    findWorkflowsWithNodeType(nodeTypes: string[], includeNodes?: boolean): Promise<(Pick<WorkflowEntity, "name" | "id" | "active"> & Partial<Pick<WorkflowEntity, "nodes">>)[]>;
    findWorkflowsNeedingIndexing(batchSize?: number): Promise<WorkflowEntity[]>;
}
export {};
