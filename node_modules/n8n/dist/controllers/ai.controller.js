...
let AiController = class AiController {
    ...
    async getSessionsMetadata(req, _, payload) {
        try {
            const metadata = await this.workflowBuilderService.getSessionsMetadata(payload.workflowId, req.user);
            return metadata;
        }
        catch (e) {
            (0, node_assert_1.strict)(e instanceof Error);
...
__decorate([
    (0, decorators_1.Licensed)('feat:aiBuilder'),
    (0, decorators_1.Post)('/sessions/metadata', { rateLimit: { limit: 100 } }),
    __param(2, decorators_1.Body),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, api_types_1.AiSessionRetrievalRequestDto]),
    __metadata("design:returntype", Promise)
], AiController.prototype, "getSessionsMetadata", null);
__decorate([
    (0, decorators_1.Licensed)('feat:aiBuilder'),
