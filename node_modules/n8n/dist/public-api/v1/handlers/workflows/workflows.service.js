...
async function updateWorkflow(existingWorkflow, updateData) {
    ...
    return await di_1.Container.get(db_1.WorkflowRepository).update(existingWorkflow.id, updateData);
}
