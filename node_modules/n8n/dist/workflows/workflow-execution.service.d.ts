...
export declare class WorkflowExecutionService {
    ...
    executeManually({ workflowData, runData, startNodes, destinationNode, dirtyNodeNames, triggerToStartFrom, agentRequest, }: WorkflowRequest.ManualRunPayload, user: User, pushRef?: string, streamingEnabled?: boolean, httpResponse?: Response): Promise<{
    ...
    executeChatWorkflow(workflowData: IWorkflowBase, executionData: IRunExecutionData, user: User, httpResponse?: Response, streamingEnabled?: boolean): Promise<{
        executionId: string;
    }>;
    executeErrorWorkflow(workflowId: string, workflowErrorData: IWorkflowErrorData, runningProject: Project): Promise<void>;
    selectPinnedActivatorStarter(workflow: IWorkflowBase, startNodes?: string[], pinData?: IPinData, destinationNode?: string): INode | null;
