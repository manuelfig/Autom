...
exports.getMaxContextWindowTokens = exports.maxContextWindowTokens = void 0;
exports.maxContextWindowTokens = {
    openai: {
...
const getMaxContextWindowTokens = (provider, model) => {
    const limit = exports.maxContextWindowTokens[provider]?.[model] ?? 0;
    if (!limit) {
        return undefined;
    }
    return limit;
};
exports.getMaxContextWindowTokens = getMaxContextWindowTokens;
