import { ChatHubSendMessageRequest, ChatModelsResponse, ChatHubConversationsResponse, ChatHubConversationResponse, ChatHubEditMessageRequest, ChatHubRegenerateMessageRequest, ChatHubUpdateConversationRequest, ChatSessionId, ChatMessageId, ChatHubCreateAgentRequest, ChatHubUpdateAgentRequest } from '@n8n/api-types';
...
export declare class ChatHubController {
    ...
    constructor(chatService: ChatHubService, chatAgentService: ChatHubAgentService, logger: Logger);
    getModels(req: AuthenticatedRequest, _res: Response, payload: ChatModelsRequestDto): Promise<ChatModelsResponse>;
    getConversations(req: AuthenticatedRequest, _res: Response): Promise<ChatHubConversationsResponse>;
