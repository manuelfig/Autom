...
let FrontendService = class FrontendService {
    ...
    getPublicSettings() {
        const { instanceId, defaultLocale, versionCli, releaseChannel, versionNotifications, userManagement, sso, mfa, authCookie, oauthCallbackUrls, banners, previewMode, telemetry, enterprise: { saml, ldap, oidc, showNonProdBanner }, } = this.getSettings();
        return {
            settingsMode: 'public',
            instanceId,
            defaultLocale,
