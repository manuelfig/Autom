...
let WorkflowBuilderService = class WorkflowBuilderService {
    constructor(loadNodesAndCredentials, license, config, logger, urlService, push) {
    ...
    async getService() {
        if (!this.service) {
            ...
            this.service = new ai_workflow_builder_1.AiWorkflowBuilderService(nodeTypeDescriptions, client, this.logger, this.urlService.getInstanceBaseUrl(), onCreditsUpdated);
        }
        return this.service;
    }
