...
async function getWorkflowData(workflowInfo, parentWorkflowId, parentWorkflowSettings) {
    ...
    if (workflowInfo.id !== undefined) {
        ...
        workflowData = await di_1.Container.get(db_1.WorkflowRepository).get({ id: workflowInfo.id }, { relations });
...
async function getBase({ userId, workflowId, projectId, currentNodeParameters, executionTimeoutTimestamp, } = {}) {
