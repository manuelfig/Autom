    ...
    return {
      ...
      execute: function () {
        ...
        InsightsDashboard_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */defineComponent({
          ...
          setup(__props) {
            const InsightsPaywall = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsPaywall-legacy-By7YqflZ.js"), true               ? void 0 : void 0));
            const InsightsChartTotal = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsChartTotal-legacy-ny-Gn0NL.js"), true               ? void 0 : void 0));
            const InsightsChartFailed = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsChartFailed-legacy-BXNV41_X.js"), true               ? void 0 : void 0));
            const InsightsChartFailureRate = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsChartFailureRate-legacy-xpR-l77z.js"), true               ? void 0 : void 0));
            const InsightsChartTimeSaved = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsChartTimeSaved-legacy-DyXMw-Zj.js"), true               ? void 0 : void 0));
            const InsightsChartAverageRuntime = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsChartAverageRuntime-legacy-C6yRYbdN.js"), true               ? void 0 : void 0));
            const InsightsTableWorkflows = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsTableWorkflows-legacy-By2jMj0_.js"), true               ? void 0 : void 0));
            const props = __props;
