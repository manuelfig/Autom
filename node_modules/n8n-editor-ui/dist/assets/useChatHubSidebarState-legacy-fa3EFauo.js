;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./_MapCache-legacy-DcX1vy0l.js", "./src-legacy-6Jvz4Sen.js", "./useTelemetry-legacy-Bu_8SoSm.js", "./constants-legacy-CLA25gM9.js", "./retry-legacy-CkXCWkMV.js", "./CredentialIcon-legacy-nJdgWX0p.js", "./constants-legacy-D22nGw-a.js"], function (_export, _context) {
    "use strict";

    var computed, unref, ref, defineComponent, toDisplayString, createBlock, withCtx, openBlock, createTextVNode, createSlots, useMediaQuery, useLocalStorage, N8nAvatar_default, N8nTooltip_default, N8nIcon_default, v4_default, useUIStore, useRootStore, useUsersStore, makeRestApiRequest, streamRequest, useTelemetry, defineStore, LOCAL_STORAGE_CHAT_HUB_STATIC_SIDEBAR, PROVIDER_CREDENTIAL_TYPE_MAP, chatHubProviderSchema, emptyChatModelsResponse, CHAT_HUB_SIDE_MENU_DRAWER_MODAL_KEY, retry, CredentialIcon_default, MOBILE_MEDIA_QUERY, CHAT_VIEW, CHAT_STORE, STREAM_SEPARATOR, fetchChatModelsApi, stopGenerationApi, fetchConversationsApi, updateConversationApi, updateConversationTitleApi, deleteConversationApi, fetchSingleConversationApi, fetchAgentApi, createAgentApi, updateAgentApi, deleteAgentApi, useChatStore, ChatAgentAvatar_vue_vue_type_script_setup_true_lang_default, ChatAgentAvatar_default;
    ...
    //#endregion
    _export({
      a: findOneFromModelsResponse,
      c: getAgentRoute,
      d: stringifyModel,
      f: unflattenModel,
      i: filterAndSortAgents,
      l: groupConversationsByDate,
      o: flattenModel,
      s: fromStringToModel,
      t: useChatHubSidebarState,
      u: isMatchedAgent
    });
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
      ...
      }, function (_retryLegacy01bJs) {
        retry = _retryLegacy01bJs.t;
        ...
        CHAT_STORE = _constantsLegacy039Js.r;
      }],
      execute: function () {
        //#region src/features/ai/chatHub/chat.api.ts
        STREAM_SEPARATOR = "\n";
        _export("p", fetchChatModelsApi = async (context, payload) => {
        ...
        fetchConversationsApi = async context => {
        ...
        _export("r", useChatStore = defineStore(CHAT_STORE, () => {
        ...
        _export("n", ChatAgentAvatar_default = ChatAgentAvatar_vue_vue_type_script_setup_true_lang_default);
      }
    };
  });
})();