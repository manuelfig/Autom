...
import { Ar as RemoveConnectionCommand, Bo as useSettingsStore, Cc as STORES, Cr as useHistoryStore, Er as BulkCommand, J as displayForm, Or as EnableNodeToggleCommand, Qs as useRootStore, Sn as injectWorkflowState, Tn as useDocumentTitle, Tr as AddNodeCommand, gi as isEmpty, jr as RemoveNodeCommand, mn as useWorkflowHelpers, o as useWorkflowsStore, t as useTelemetry, wr as AddConnectionCommand, xc as defineStore, xn as useNodeHelpers, xr as CanvasNodeDirtiness } from "./useTelemetry-DedEakwK.js";
import { t as useToast } from "./useToast-LQk5sJH0.js";
import { N as IN_PROGRESS_EXECUTION_ID, Q as CHAT_TRIGGER_NODE_TYPE, ea as NodeConnectionTypes, fs as LOCAL_STORAGE_RUN_DATA_WORKER, hn as SINGLE_WEBHOOK_TRIGGERS, pi as generateNodesGraph, sr as createHeartbeatMessage } from "./constants-C5Tj3dXQ.js";
...
function useRunWorkflow(useRunWorkflowOpts) {
	...
	async function runWorkflow(options) {
		...
		try {
			...
			else if (options.destinationNode) executedNode = options.destinationNode;
			...
			if (singleWebhookTrigger && workflowsStore.isWorkflowActive && !workflowData.pinData?.[singleWebhookTrigger.name]) {
				toast.showMessage({
					...
					message: i18n.baseText("workflowRun.showError.productionActive", { interpolate: { nodeName: singleWebhookTrigger.name } }),
					type: "error"
				});
				return;
			}
