;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./_MapCache-legacy-DcX1vy0l.js", "./preload-helper-legacy-CXRjoQ0T.js", "./truncate-legacy-D2_XDpGK.js", "./useTelemetry-legacy-Bu_8SoSm.js", "./useToast-legacy-CIRx5txg.js", "./constants-legacy-CLA25gM9.js", "./useExternalHooks-legacy-DAJrb39U.js", "./npsSurvey.store-legacy-oZP0npqy.js", "./cloudPlan.store-legacy-BPgz6zU7.js", "./templates.store-legacy-CPyYqMqR.js", "./nodeCreator.store-legacy-CjrGX9Lm.js", "./versions.store-legacy-ZeK5FOAp.js", "./banners.store-legacy-DUTxfINX.js", "./dataTable.store-legacy-BKpQb7Gy.js", "./roles.store-legacy-BxleDMZw.js", "./sso.store-legacy-Ci_mQS0X.js", "./insights.store-legacy-XeWToovL.js", "./mcp.constants-legacy-CZfk8DW2.js", "./constants-legacy-D22nGw-a.js", "./useRecentResources-legacy-CdJaBL9r.js"], function (_export, _context) {
    "use strict";
    ...
    */
    ...
    return {
      ...
      execute: function () {
        ...
        i18n$1 = useI18n();
        MainSidebar$3 = async () => await __vitePreload(() => _context.import("./MainSidebar-legacy-CNRw0zHi.js"), true               ? void 0 : void 0);
        DataTableView = async () => await __vitePreload(() => _context.import("./DataTableView-legacy-Bs1jkgGw.js"), true               ? void 0 : void 0);
        DataTableDetailsView = async () => await __vitePreload(() => _context.import("./DataTableDetailsView-legacy-T6s1xIYP.js"), true               ? void 0 : void 0);
        DataTableModule = {
          id: "data-table",
          name: "Data Table",
          ...
          modals: [{
            ...
            component: async () => await __vitePreload(() => _context.import("./AddDataTableModal-legacy-TWGqOwvJ.js"), true               ? void 0 : void 0),
            initialState: {
              open: false
            }
          }],
        ...
        MainSidebar$2 = async () => await __vitePreload(() => _context.import("./MainSidebar-legacy-CNRw0zHi.js"), true               ? void 0 : void 0);
        InsightsDashboard = async () => await __vitePreload(() => _context.import("./InsightsDashboard-legacy-bfD59wUo.js"), true               ? void 0 : void 0);
        InsightsModule = {
          id: "insights",
          name: "Insights",
        ...
        i18n = useI18n();
        SettingsMCPView = async () => await __vitePreload(() => _context.import("./SettingsMCPView-legacy-B8E45TNn.js"), true               ? void 0 : void 0);
        MCPModule = {
          id: "mcp",
          name: "MCP Access",
        ...
        ChatSidebar = async () => await __vitePreload(() => _context.import("./ChatSidebar-legacy-BcM0mdnb.js"), true               ? void 0 : void 0);
        ChatView = async () => await __vitePreload(() => _context.import("./ChatView-legacy-DQzrDKVi.js"), true               ? void 0 : void 0);
        ChatAgentsView = async () => await __vitePreload(() => _context.import("./ChatAgentsView-legacy-C-TEUCMJ.js"), true               ? void 0 : void 0);
        ChatModule = {
          id: "chat-hub",
          name: "Chat",
        ...
        */
        ...
        MainSidebar$1 = async () => await __vitePreload(() => _context.import("./MainSidebar-legacy-CNRw0zHi.js"), true               ? void 0 : void 0);
        WorkflowsView = async () => await __vitePreload(() => _context.import("./WorkflowsView-legacy-BpAAeN0R.js"), true               ? void 0 : void 0);
        CredentialsView = async () => await __vitePreload(() => _context.import("./CredentialsView-legacy-CBU7oObS.js"), true               ? void 0 : void 0);
        ProjectSettings = async () => await __vitePreload(() => _context.import("./ProjectSettings-legacy-BPsXj5XT.js"), true               ? void 0 : void 0);
        ExecutionsView = async () => await __vitePreload(() => _context.import("./ExecutionsView-legacy-DD0RXem0.js"), true               ? void 0 : void 0);
        ProjectVariables = async () => await __vitePreload(() => _context.import("./ProjectVariables-legacy-DfW6sdX0.js"), true               ? void 0 : void 0);
        ...
        ChangePasswordView = async () => await __vitePreload(() => _context.import("./ChangePasswordView-legacy-UYMze_th.js"), true               ? void 0 : void 0);
        ErrorView = async () => await __vitePreload(() => _context.import("./ErrorView-legacy-CtfV-zYc.js"), true               ? void 0 : void 0);
        EntityNotFound = async () => await __vitePreload(() => _context.import("./EntityNotFound-legacy-Bfl0-2gj.js"), true               ? void 0 : void 0);
        EntityUnAuthorised = async () => await __vitePreload(() => _context.import("./EntityUnAuthorised-legacy-DLIqjuJf.js"), true               ? void 0 : void 0);
        OAuthConsentView = async () => await __vitePreload(() => _context.import("./OAuthConsentView-legacy-CT4ApTLs.js"), true               ? void 0 : void 0);
        ForgotMyPasswordView = async () => await __vitePreload(() => _context.import("./ForgotMyPasswordView-legacy-BbZiFRc2.js"), true               ? void 0 : void 0);
        MainHeader = async () => await __vitePreload(() => _context.import("./MainHeader-legacy-B3RrmiZE.js"), true               ? void 0 : void 0);
        MainSidebar = async () => await __vitePreload(() => _context.import("./MainSidebar-legacy-CNRw0zHi.js"), true               ? void 0 : void 0);
        LogsPanel = async () => await __vitePreload(() => _context.import("./LogsPanel-legacy-ByvltTa3.js"), true               ? void 0 : void 0);
        DemoFooter = async () => await __vitePreload(() => _context.import("./DemoFooter-legacy-BDdJ7htI.js"), true               ? void 0 : void 0);
        NodeView = async () => await __vitePreload(() => _context.import("./NodeView-legacy-B7u8GgSk.js"), true               ? void 0 : void 0);
        WorkflowExecutionsView = async () => await __vitePreload(() => _context.import("./WorkflowExecutionsView-legacy-C6eVhTue.js"), true               ? void 0 : void 0);
        WorkflowExecutionsLandingPage = async () => await __vitePreload(() => _context.import("./WorkflowExecutionsLandingPage-legacy-DaS6jgLc.js"), true               ? void 0 : void 0);
        WorkflowExecutionsPreview = async () => await __vitePreload(() => _context.import("./WorkflowExecutionsPreview-legacy-BZAG_FE2.js"), true               ? void 0 : void 0);
        SettingsView = async () => await __vitePreload(() => _context.import("./SettingsView-legacy-hgJAMD5w.js"), true               ? void 0 : void 0);
        SettingsLdapView = async () => await __vitePreload(() => _context.import("./SettingsLdapView-legacy-D5vgdVWc.js"), true               ? void 0 : void 0);
        SettingsPersonalView = async () => await __vitePreload(() => _context.import("./SettingsPersonalView-legacy-BCa5pb35.js"), true               ? void 0 : void 0);
        SettingsUsersView = async () => await __vitePreload(() => _context.import("./SettingsUsersView-legacy-D39e8lpD.js"), true               ? void 0 : void 0);
        SettingsCommunityNodesView = async () => await __vitePreload(() => _context.import("./SettingsCommunityNodesView-legacy-BKyymFU0.js"), true               ? void 0 : void 0);
        SettingsApiView = async () => await __vitePreload(() => _context.import("./SettingsApiView-legacy-C9zAm0u7.js"), true               ? void 0 : void 0);
        SettingsLogStreamingView = async () => await __vitePreload(() => _context.import("./SettingsLogStreamingView-legacy-CQ8nq1FW.js"), true               ? void 0 : void 0);
        SetupView = async () => await __vitePreload(() => _context.import("./SetupView-legacy-yEyZVczN.js"), true               ? void 0 : void 0);
        SigninView = async () => await __vitePreload(() => _context.import("./SigninView-legacy-wkJIfoQV.js"), true               ? void 0 : void 0);
        SignupView = async () => await __vitePreload(() => _context.import("./SignupView-legacy-2pnkjTn7.js"), true               ? void 0 : void 0);
        TemplatesCollectionView = async () => await __vitePreload(() => _context.import("./TemplatesCollectionView-legacy-HXEUNo_l.js"), true               ? void 0 : void 0);
        TemplatesWorkflowView = async () => await __vitePreload(() => _context.import("./TemplatesWorkflowView-legacy-C_2wkoc1.js"), true               ? void 0 : void 0);
        SetupWorkflowFromTemplateView = async () => await __vitePreload(() => _context.import("./SetupWorkflowFromTemplateView-legacy-ByqlU9fc.js"), true               ? void 0 : void 0);
        TemplatesSearchView = async () => await __vitePreload(() => _context.import("./TemplatesSearchView-legacy-28acdtqn.js"), true               ? void 0 : void 0);
        SettingsUsageAndPlan = async () => await __vitePreload(() => _context.import("./SettingsUsageAndPlan-legacy-m-cDuLWb.js"), true               ? void 0 : void 0);
        SettingsSso = async () => await __vitePreload(() => _context.import("./SettingsSso-legacy-BTbHZn2L.js"), true               ? void 0 : void 0);
        SignoutView = async () => await __vitePreload(() => _context.import("./SignoutView-legacy-7HQWbMDt.js"), true               ? void 0 : void 0);
        SamlOnboarding = async () => await __vitePreload(() => _context.import("./SamlOnboarding-legacy-3hKQbF8_.js"), true               ? void 0 : void 0);
        SettingsSourceControl = async () => await __vitePreload(() => _context.import("./SettingsSourceControl-legacy-BdmpiLob.js"), true               ? void 0 : void 0);
        SettingsExternalSecrets = async () => await __vitePreload(() => _context.import("./SettingsExternalSecrets-legacy-CUMq_ivN.js"), true               ? void 0 : void 0);
        SettingsProvisioningView = async () => await __vitePreload(() => _context.import("./SettingsProvisioningView-legacy-7LiGCRgO.js"), true               ? void 0 : void 0);
        WorkerView = async () => await __vitePreload(() => _context.import("./WorkerView-legacy-DMYRM_Cm.js"), true               ? void 0 : void 0);
        WorkflowHistory = async () => await __vitePreload(() => _context.import("./WorkflowHistory-legacy-D9EpXPrw.js"), true               ? void 0 : void 0);
        WorkflowOnboardingView = async () => await __vitePreload(() => _context.import("./WorkflowOnboardingView-legacy-DGVGXrbp.js"), true               ? void 0 : void 0);
        EvaluationsView = async () => await __vitePreload(() => _context.import("./EvaluationsView-legacy-DfePizpg.js"), true               ? void 0 : void 0);
        TestRunDetailView = async () => await __vitePreload(() => _context.import("./TestRunDetailView-legacy-hQli5No4.js"), true               ? void 0 : void 0);
        EvaluationRootView = async () => await __vitePreload(() => _context.import("./EvaluationsRootView-legacy-DNES1nzh.js"), true               ? void 0 : void 0);
        PrebuiltAgentTemplatesView = async () => await __vitePreload(() => _context.import("./PrebuiltAgentTemplatesView-legacy-DYhUlIns.js"), true               ? void 0 : void 0);
        routes = [{
          path: "/",
          redirect: "/home/workflows",
          meta: {
          ...
          children: [{
            ...
            children: [{
              ...
              component: async () => await __vitePreload(() => _context.import("./ProjectRolesView-legacy-CWMn_I7U.js"), true               ? void 0 : void 0)
            }, {
              path: "new",
              name: VIEWS.PROJECT_NEW_ROLE,
              component: async () => await __vitePreload(() => _context.import("./ProjectRoleView-legacy-BO9-6Zog.js"), true               ? void 0 : void 0)
            }, {
              path: "edit/:roleSlug",
