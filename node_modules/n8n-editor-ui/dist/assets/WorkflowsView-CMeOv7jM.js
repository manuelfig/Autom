...
import { C as computed, D as createElementBlock, E as createCommentVNode, Gt as unref, It as ref, J as onBeforeUnmount, M as createVNode, Nt as onScopeDispose, P as defineComponent, Sn as toDisplayString, T as createBlock, Z as onMounted, _ as Fragment, _n as normalizeClass, _t as watch, at as renderSlot, bt as withCtx, et as openBlock, h as withModifiers, it as renderList, j as createTextVNode, k as createSlots, mt as useTemplateRef, ot as resolveComponent, p as vShow, w as createBaseVNode, xt as withDirectives } from "./vue.runtime.esm-bundler-DDuXT-9r.js";
import { gt as useI18n } from "./_MapCache-Dw6Llo22.js";
import { $ as N8nActionToggle_default, Dt as N8nActionBox_default, Fn as N8nCallout_default, G as N8nOption_default, In as N8nText_default, J as N8nCheckbox_default, Ln as N8nButton_default, P as N8nInfoTip_default, Pn as N8nHeading_default, W as N8nSelect_default, X as N8nCard_default, Y as N8nInputLabel_default, a as N8nInlineTextEdit_default, c as N8nBreadcrumbs_default, et as N8nLoading_default, h as N8nTags_default, it as N8nBadge_default, mt as N8nLink_default, vt as N8nTooltip_default, zn as N8nIcon_default } from "./src-DsaRShTK.js";
...
import { Bo as useSettingsStore, Cc as STORES, Dn as useSourceControlStore, En as useProjectsStore, Ir as ResourceType, Ji as FOLDER_LIST_ITEM_ACTIONS, Ni as useUIStore, On as ProjectTypes, Qi as ILLEGAL_FOLDER_CHARACTERS, Tn as useDocumentTitle, Tt as getEasyAiWorkflowJson, Wi as PROJECT_MOVE_RESOURCE_MODAL, Xi as FOLDER_NAME_MAX_LENGTH, Yi as FOLDER_NAME_ILLEGAL_CHARACTERS_REGEX, Zi as FOLDER_NAME_ONLY_DOTS_REGEX, _n as useTagsStore, er as useUsersStore, i as usePostHog, ko as COMMUNITY_PLUS_ENROLLMENT_MODAL, o as useWorkflowsStore, rt as useNodeTypesStore, t as useTelemetry, xc as defineStore, zo as useStorage } from "./useTelemetry-DedEakwK.js";
import { t as useToast } from "./useToast-LQk5sJH0.js";
import "./sanitize-html-Cfxibw1n.js";
import "./path-browserify-CTmc1OxV.js";
import { Bs as TEMPLATE_ONBOARDING_EXPERIMENT, Co as EXPERIMENT_TEMPLATE_RECO_V2_KEY, Gi as jsonParse, Hs as EnterpriseEditionFeature, Jo as WORKFLOW_SHARE_MODAL_KEY, No as MODAL_CONFIRM, So as EXPERIMENT_TEMPLATES_DATA_QUALITY_KEY, _r as getResourcePermissions, ba as PROJECT_ROOT, es as LOCAL_STORAGE_EXPERIMENTAL_DISMISSED_SUGGESTED_WORKFLOWS, mo as VIEWS, r as DEFAULT_WORKFLOW_PAGE_SIZE, wo as EXPERIMENT_TEMPLATE_RECO_V3_KEY, xo as DUPLICATE_MODAL_KEY } from "./constants-C5Tj3dXQ.js";
...
import { t as useCloudPlanStore } from "./cloudPlan.store-DT2PFV79.js";
...
import { _ as useCalloutHelpers } from "./nodeCreator.store-C1GkQ_2N.js";
...
import { t as ProjectCardBadge_default } from "./ProjectCardBadge-CR1M799A.js";
import { t as useUsageStore } from "./usage.store-Xl7x6DGx.js";
import { t as Draggable_default } from "./Draggable-Cp3VJXN0.js";
import "./EnterpriseEdition.ee-Dmuvy1Qj.js";
import { t as TimeAgo_default } from "./TimeAgo-BFJOHR5_.js";
import "./orderBy-FDQLKrkD.js";
import "./ProjectSharing-CSeX6YY5.js";
import "./TagsDropdown-sf5rCG4m.js";
import { t as WorkflowTagsDropdown_default } from "./WorkflowTagsDropdown-DTUxLHbz.js";
import { t as useInsightsStore } from "./insights.store-aHF8maKY.js";
import "./insights.constants-DK2g3nnD.js";
import "./insights.utils-ClwWcg-l.js";
import "./mcp.constants-BCNosk1p.js";
import { t as useMcp } from "./useMcp-CXTbPxKj.js";
import { n as usePersonalizedTemplatesV2Store, t as usePersonalizedTemplatesV3Store } from "./personalizedTemplatesV3.store-alXco4LN.js";
...
import { n as useProjectPages, t as useReadyToRunWorkflowsV2Store } from "./readyToRunWorkflowsV2.store-BJAu2HwR.js";
import "./PageViewLayout-kj_BBPfv.js";
import { t as EmptySharedSectionActionBox_default } from "./EmptySharedSectionActionBox-D83jdITF.js";
import { t as ResourcesListLayout_default } from "./ResourcesListLayout-Cf-VCtXT.js";
import { t as ProjectHeader_default } from "./ProjectHeader-L2nKcFJq.js";
import { t as useMCPStore } from "./mcp.store-Bd62s_4P.js";
import "./smartDecimal-e9uPsnJa.js";
import { t as InsightsSummary_default } from "./InsightsSummary-DsQSWG2Q.js";
...
const cardLink = "_cardLink_g126n_123";
const cardHeading = "_cardHeading_g126n_133";
const cardHeadingArchived = "_cardHeadingArchived_g126n_142";
const cardDescription = "_cardDescription_g126n_150";
const cardTags = "_cardTags_g126n_160";
const cardActions = "_cardActions_g126n_165";
const cardBadge = "_cardBadge_g126n_176";
const cardArchived = "_cardArchived_g126n_187";
const breadcrumbs = "_breadcrumbs_g126n_213";
...
var SimplifiedEmptyLayout_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const emit = __emit;
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.simplifiedLayout) }, [createBaseVNode("div", { class: normalizeClass(_ctx.$style.content) }, [createBaseVNode("div", { class: normalizeClass(_ctx.$style.welcome) }, [createVNode(unref(N8nHeading_default), {
				tag: "h1",
				size: "2xlarge",
...
var SimplifiedEmptyLayout_vue_vue_type_style_index_0_lang_module_default = {
	...
	actionsContainer: "_actionsContainer_pnu6z_158",
	actionCard: "_actionCard_pnu6z_165",
	cardIcon: "_cardIcon_pnu6z_178",
	loading: "_loading_pnu6z_181",
	cardContent: "_cardContent_pnu6z_186"
};
var SimplifiedEmptyLayout_default = /* @__PURE__ */ __plugin_vue_export_helper_default(SimplifiedEmptyLayout_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": SimplifiedEmptyLayout_vue_vue_type_style_index_0_lang_module_default }]]);
			...
			return shouldUseSimplifiedLayout.value ? (openBlock(), createBlock(SimplifiedEmptyLayout_default, {
				...
				empty: withCtx(() => [unref(projectPages).isSharedSubPage && personalProject.value ? (openBlock(), createBlock(EmptySharedSectionActionBox_default, {
					...
					!readOnlyEnv.value && projectPermissions.value.workflow.create ? (openBlock(), createElementBlock("div", {
						...
						templatesCardEnabled.value ? (openBlock(), createBlock(unref(N8nCard_default), {
							key: 4,
							class: normalizeClass(_ctx.$style.emptyStateCard),
							hoverable: "",
					...
					showTemplateRecommendationV3.value ? (openBlock(), createBlock(TemplateRecommendationV3_default, { key: 1 })) : showTemplateRecommendationV2.value ? (openBlock(), createBlock(TemplateRecommendationV2_default, { key: 2 })) : createCommentVNode("", true)
				]))]),
...
const actionsContainer = "_actionsContainer_7a9z2_123";
const emptyStateCard = "_emptyStateCard_7a9z2_139";
const emptyStateCardContent = "_emptyStateCardContent_7a9z2_152";
const emptyStateCardIcon = "_emptyStateCardIcon_7a9z2_159";
const dragging = "_dragging_7a9z2_192";
const name = "_name_7a9z2_210";
