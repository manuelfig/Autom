...
import { C as computed, D as createElementBlock, E as createCommentVNode, Gt as unref, It as ref, J as onBeforeUnmount, M as createVNode, P as defineComponent, Sn as toDisplayString, T as createBlock, Z as onMounted, _ as Fragment, _n as normalizeClass, _t as watch, bt as withCtx, et as openBlock, h as withModifiers, it as renderList, j as createTextVNode, k as createSlots, n as Transition, p as vShow, st as resolveDirective, w as createBaseVNode, xt as withDirectives, zt as shallowRef } from "./vue.runtime.esm-bundler-DDuXT-9r.js";
import { _t as I18nT, gt as useI18n } from "./_MapCache-Dw6Llo22.js";
import { F as N8nInfoAccordion_default, In as N8nText_default, Ln as N8nButton_default, P as N8nInfoTip_default, Pn as N8nHeading_default, Rn as N8nSpinner_default, S as N8nPulse_default, mt as N8nLink_default, vt as N8nTooltip_default, x as N8nRadioButtons_default, zn as N8nIcon_default } from "./src-DsaRShTK.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-BwBpWJRZ.js";
import { b as useRouter, x as createEventBus } from "./truncate-7XypoloM.js";
import { K as parseAiContent, Ni as useUIStore, Qr as getTriggerNodeServiceName, Sc as storeToRefs, Sn as injectWorkflowState, W as formatTokenUsageCount, a as useNDVStore, i as usePostHog, mn as useWorkflowHelpers, nt as waitingNodeTooltip, o as useWorkflowsStore, pr as isTriggerPanelObject, rt as useNodeTypesStore, t as useTelemetry, xr as CanvasNodeDirtiness } from "./useTelemetry-DedEakwK.js";
import { On as WEBHOOK_NODE_TYPE, Ps as NDV_UI_OVERHAUL_EXPERIMENT, Q as CHAT_TRIGGER_NODE_TYPE, St as FORM_TRIGGER_NODE_TYPE, ea as NodeConnectionTypes, gs as MAX_DISPLAY_DATA_SIZE_LOGS_VIEW, mo as VIEWS, qo as WORKFLOW_SETTINGS_MODAL_KEY } from "./constants-C5Tj3dXQ.js";
import { r as useNodeDirtiness } from "./useRunWorkflow-BLqckUNU.js";
import { n as useNodeType, t as usePinnedData } from "./usePinnedData-BsuIBj2b.js";
import { y as require_capitalize } from "./nodeCreator.store-C1GkQ_2N.js";
import { t as NodeIcon_default } from "./NodeIcon-BYTrCZAx.js";
import { t as CopyInput_default } from "./CopyInput-CiPK5ddq.js";
import { a as NodeErrorView_default, i as ViewSubExecution_default, n as RunData_default } from "./isEmpty-Dg0afC99.js";
import { t as NDVEmptyState_default } from "./NDVEmptyState-C7QVArdv.js";
...
import { n as convertToDisplayDateComponents } from "./dateFormatter-DysKGI6w.js";
import { t as useExecutionData } from "./useExecutionData-D1Hu-5sr.js";
import { c as findLogEntryById, d as getConsumedTokens, n as useLogsExecutionData, o as ConsumedTokensDetails_default, r as LogsOverviewRows_default, t as useLogsTreeExpand } from "./useLogsTreeExpand-VaIZtJEy.js";
import { n as getReferencedData, t as RunDataParsedAiContent_default } from "./RunDataParsedAiContent-BVsW98ij.js";
var _hoisted_1$3 = [
	"data-node-name",
	"data-node-placement",
	"onClick"
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.block) }, [createBaseVNode("header", {
				...
				default: withCtx(() => [withDirectives(createBaseVNode("span", null, null, 512), [[_directive_n8n_html, unref(i18n).baseText("ndv.output.logs.tooMuchData.message", { interpolate: {
