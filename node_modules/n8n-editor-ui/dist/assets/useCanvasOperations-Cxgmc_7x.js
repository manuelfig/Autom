...
import { C as computed, G as nextTick, It as ref, zt as shallowRef } from "./vue.runtime.esm-bundler-DDuXT-9r.js";
import { gt as useI18n, j as useLocalStorage } from "./_MapCache-Dw6Llo22.js";
import { b as useRouter, x as createEventBus, y as useRoute } from "./truncate-7XypoloM.js";
import { $ as getExecutionErrorToastConfiguration, Ar as RemoveConnectionCommand, Bo as useSettingsStore, Ci as tryToParseNumber, Cr as useHistoryStore, En as useProjectsStore, G as isChatNode, Ht as useCredentialsStore, Io as v4_default, Mr as RenameNodeCommand, Ni as useUIStore, Nr as ReplaceNodeParametersCommand, Qs as useRootStore, S as getNodesGroupSize, Sn as injectWorkflowState, Sr as CanvasNodeRenderType, Tr as AddNodeCommand, Un as useCanvasStore, Zt as useDataSchema, _n as useTagsStore, a as useNDVStore, b as getNewNodePosition, br as CanvasConnectionMode, d as DEFAULT_VIEWPORT_BOUNDARIES, f as GRID_SIZE, gr as isValidNodeConnectionType, h as generateOffsets, i as usePostHog, jr as RemoveNodeCommand, kr as MoveNodeCommand, l as CONFIGURATION_NODE_SIZE, mn as useWorkflowHelpers, o as useWorkflowsStore, p as PUSH_NODES_OFFSET, rt as useNodeTypesStore, s as CONFIGURABLE_NODE_SIZE, t as useTelemetry, u as DEFAULT_NODE_SIZE, vi as isPresent, wr as AddConnectionCommand, xc as defineStore, xn as useNodeHelpers } from "./useTelemetry-DedEakwK.js";
import { t as useToast } from "./useToast-LQk5sJH0.js";
import { Br as require_cloneDeep, En as UPDATE_WEBHOOK_ID_NODE_TYPES, Hi as deepCopy, Hs as EnterpriseEditionFeature, Ns as NDV_IN_FOCUS_PANEL_EXPERIMENT, On as WEBHOOK_NODE_TYPE, Qr as require__baseUniq, St as FORM_TRIGGER_NODE_TYPE, Ui as isCommunityPackageName, _i as getNodeInputs, as as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, ea as NodeConnectionTypes, gi as getConnectionTypes, is as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, ks as CANVAS_ZOOMED_VIEW_EXPERIMENT, mo as VIEWS, os as LOCAL_STORAGE_LOGS_PANEL_OPEN, pi as generateNodesGraph, ss as LOCAL_STORAGE_LOGS_SYNC_SELECTION, vi as getNodeOutputs, wi as getSubworkflowId, xn as STICKY_NODE_TYPE, yi as getNodeParameters, zt as MCP_TRIGGER_NODE_TYPE } from "./constants-C5Tj3dXQ.js";
import { t as useExternalHooks } from "./useExternalHooks-DSSTcvme.js";
import { t as useTemplatesStore } from "./templates.store-Bt8tpLPx.js";
...
import { a as mapCanvasConnectionToLegacyConnection, l as parseCanvasConnectionHandleString, o as mapLegacyConnectionToCanvasConnection, r as createCanvasConnectionHandleString, s as mapLegacyConnectionsToCanvasConnections, t as useNodeCreatorStore } from "./nodeCreator.store-C1GkQ_2N.js";
