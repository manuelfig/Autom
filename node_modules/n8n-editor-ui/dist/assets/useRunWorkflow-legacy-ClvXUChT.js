;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./_MapCache-legacy-DcX1vy0l.js", "./truncate-legacy-D2_XDpGK.js", "./useTelemetry-legacy-Bu_8SoSm.js", "./useToast-legacy-CIRx5txg.js", "./constants-legacy-CLA25gM9.js", "./useExternalHooks-legacy-DAJrb39U.js", "./useWorkflowSaving-legacy-8U0vS257.js", "./retry-legacy-CkXCWkMV.js", "./executions.store-legacy-BzRopbKX.js", "./useCanvasOperations-legacy-DDhXmhZf.js"], function (_export, _context) {
    "use strict";

    var __toESM, computed, ref, watch, useI18n, useLocalStorage, require_get, RemoveConnectionCommand, useSettingsStore, STORES, useHistoryStore, BulkCommand, displayForm, EnableNodeToggleCommand, useRootStore, injectWorkflowState, useDocumentTitle, AddNodeCommand, isEmpty, RemoveNodeCommand, useWorkflowHelpers, useWorkflowsStore, useTelemetry, AddConnectionCommand, defineStore, useNodeHelpers, CanvasNodeDirtiness, useToast, IN_PROGRESS_EXECUTION_ID, CHAT_TRIGGER_NODE_TYPE, NodeConnectionTypes, LOCAL_STORAGE_RUN_DATA_WORKER, SINGLE_WEBHOOK_TRIGGERS, generateNodesGraph, createHeartbeatMessage, useExternalHooks, useWorkflowSaving, retry, useExecutionsStore, useCanvasOperations, useHeartbeat, useReconnectTimer, useWebSocketClient, useEventSourceClient, proxyMarker, createEndpoint, releaseProxy, finalizer, throwMarker, isObject, transferHandlers, proxyCounter, proxyFinalizers, transferCache, worker, runDataWorker, usePushConnectionStore, LOCAL_STORAGE_AGENT_REQUESTS, useAgentRequestStore, import_get;
    ...
    */
    ...
    function useRunWorkflow(useRunWorkflowOpts) {
      ...
      async function runWorkflow(options) {
        ...
        try {
          ...
          if (options.destinationNode !== void 0) directParentNodes = workflowObject.value.getParentNodes(options.destinationNode, NodeConnectionTypes.Main, -1);
          ...
          } else if (options.triggerNode && options.nodeData && !options.rerunTriggerNode) startNodeNames.push(...workflowObject.value.getChildNodes(options.triggerNode, NodeConnectionTypes.Main, 1));else if (options.destinationNode) executedNode = options.destinationNode;
          if (options.triggerNode) triggerToStartFrom = {
            name: options.triggerNode,
            data: options.nodeData
          };
          if (options.destinationNode && (workflowsStore.checkIfNodeHasChatParent(options.destinationNode) || destinationNodeType === "@n8n/n8n-nodes-langchain.chatTrigger") && options.source !== "RunData.ManualChatMessage") {
          ...
          const startNodes = sortNodesByYPosition(startNodeNames).map(name => {
            ...
            if (options.destinationNode && workflowsStore.checkIfNodeHasChatParent(options.destinationNode)) return node.name !== options.destinationNode;
            return true;
          });
          ...
          if ("destinationNode" in options) {
            ...
            const nodeId = workflowsStore.getNodeByName(options.destinationNode)?.id;
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        BulkCommand = _useTelemetryLegacy00FJs.Er;
        displayForm = _useTelemetryLegacy00FJs.J;
        EnableNodeToggleCommand = _useTelemetryLegacy00FJs.Or;
        ...
        IN_PROGRESS_EXECUTION_ID = _constantsLegacy00NJs.N;
        CHAT_TRIGGER_NODE_TYPE = _constantsLegacy00NJs.Q;
        NodeConnectionTypes = _constantsLegacy00NJs.ea;
        LOCAL_STORAGE_RUN_DATA_WORKER = _constantsLegacy00NJs.fs;
        SINGLE_WEBHOOK_TRIGGERS = _constantsLegacy00NJs.hn;
        generateNodesGraph = _constantsLegacy00NJs.pi;
        createHeartbeatMessage = _constantsLegacy00NJs.sr;
      ...
      execute: function () {
        ...
        */
        ...
        "/%7B%7BBASE_PATH%7D%7D/assets/worker-CIvWfg3a.js", "" + _context.meta.url), {
          type: "module"
        });
