...
import { C as computed, D as createElementBlock, E as createCommentVNode, F as getCurrentInstance, G as nextTick, Gt as unref, It as ref, J as onBeforeUnmount, L as h, M as createVNode, P as defineComponent, Pt as reactive, Sn as toDisplayString, T as createBlock, Ut as toValue, Z as onMounted, _ as Fragment, _n as normalizeClass, _t as watch, at as renderSlot, bt as withCtx, et as openBlock, h as withModifiers, it as renderList, j as createTextVNode, mt as useTemplateRef, p as vShow, pt as useSlots, w as createBaseVNode, xt as withDirectives, yn as normalizeStyle } from "./vue.runtime.esm-bundler-DDuXT-9r.js";
import { E as useElementSize, G as isClient, J as noop, K as isIOS, N as useResizeObserver, Q as toRef, W as directiveHooks, Y as notNullish, _t as I18nT, ct as isVue2, et as toValue$1, g as onClickOutside, gt as useI18n, it as useThrottleFn, nt as tryOnScopeDispose, q as isObject, rt as useDebounceFn, tt as tryOnMounted } from "./_MapCache-Dw6Llo22.js";
import { E as N8nNotice_default, Fn as N8nCallout_default, In as N8nText_default, Ln as N8nButton_default, Q as N8nBlockUi_default, Tt as N8nIconButton_default, a as N8nInlineTextEdit_default, g as N8nTabs_default, vt as N8nTooltip_default, x as N8nRadioButtons_default, zn as N8nIcon_default, zt as ElCollapseTransition } from "./src-DsaRShTK.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-BwBpWJRZ.js";
import { r as require_get, y as useRoute } from "./truncate-7XypoloM.js";
import { E as TitledList_default, T as useNodeCredentialOptions, d as collectParametersByTab, f as collectSettings, h as getNodeSettingsInitialValues, p as createCommonNodeSettings, t as ParameterInputList_default, u as useNodeSettingsParameters, v as nameIsParameter, w as NodeCredentials_default } from "./ParameterInputList-DTj_ngLA.js";
import { n as ElRow, t as ElCol } from "./col-Da3-PCMn.js";
import { Bo as useSettingsStore, Cr as useHistoryStore, Di as importCurlEventBus, En as useProjectsStore, Ht as useCredentialsStore, Mr as RenameNodeCommand, Ni as useUIStore, On as ProjectTypes, Ri as COMMUNITY_NODES_INSTALLATION_DOCS_URL, Sn as injectWorkflowState, Vi as COMMUNITY_PACKAGE_INSTALL_MODAL_KEY, a as useNDVStore, er as useUsersStore, it as useActionsGenerator, mn as useWorkflowHelpers, o as useWorkflowsStore, rt as useNodeTypesStore, t as useTelemetry, vt as removePreviewToken, xn as useNodeHelpers } from "./useTelemetry-DedEakwK.js";
import { t as useToast } from "./useToast-LQk5sJH0.js";
import { Hi as deepCopy, I as CUSTOM_API_CALL_KEY, Q as CHAT_TRIGGER_NODE_TYPE, St as FORM_TRIGGER_NODE_TYPE, Ui as isCommunityPackageName, _i as getNodeInputs, c as BASE_NODE_SURVEY_URL, ea as NodeConnectionTypes, en as OPEN_URL_PANEL_TRIGGER_NODE_TYPES, f as CUSTOM_NODES_DOCS_URL, mo as VIEWS, rn as PRODUCTION_ONLY_TRIGGER_NODE_TYPES, st as DATA_TABLE_NODES, u as BUILTIN_NODES_DOCS_URL, x as NPM_PACKAGE_DOCS_BASE_URL, ya as OPEN_AI_API_CREDENTIAL_TYPE, yi as getNodeParameters, zt as MCP_TRIGGER_NODE_TYPE } from "./constants-C5Tj3dXQ.js";
import { n as ndvEventBus } from "./assistant.store-BtplYeLr.js";
import { t as useDebounce } from "./useDebounce-DFa0sFlC.js";
import { t as useExternalHooks } from "./useExternalHooks-DSSTcvme.js";
import { t as useNodeCreatorStore } from "./nodeCreator.store-C1GkQ_2N.js";
...
import { t as useDataTableStore } from "./dataTable.store-BC5cIRU-.js";
import { a as useInstallNode, i as useInstalledCommunityPackage, n as CommunityNodeFooter_default, r as ContactAdministratorToInstall_default, t as CommunityNodeUpdateInfo_default } from "./CommunityNodeUpdateInfo-BbQHVpK8.js";
import { n as NodeExecuteButton_default } from "./VirtualSchema-BPKNcaHe.js";
import { t as useActions } from "./useActions-BeWbvBcf.js";
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				createVNode(unref(N8nBlockUi_default), { show: _ctx.blockUI }, null, 8, ["show"]),
...
var NodeSettings_default = /* @__PURE__ */ __plugin_vue_export_helper_default(NodeSettings_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": NodeSettings_vue_vue_type_style_index_0_lang_module_default }], ["__scopeId", "data-v-e107ee77"]]);
