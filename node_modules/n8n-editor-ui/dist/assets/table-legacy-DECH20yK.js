;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./src-legacy-6Jvz4Sen.js", "./truncate-legacy-D2_XDpGK.js", "./icon-legacy-gLTnORTx.js"], function (_export, _context) {
    "use strict";

    var __toESM, __commonJS, onUpdated, hasOwn, computed, createElementBlock, createCommentVNode, getCurrentInstance, nextTick, unref, toRefs, ref, onBeforeUnmount, h, createVNode, defineComponent, onUnmounted, toDisplayString, createBlock, onMounted, Fragment, normalizeClass, watch, renderSlot, withCtx, isObject, openBlock, Comment, renderList, createTextVNode, isRef, isArray, provide, resolveComponent, vShow, isString, onBeforeMount, resolveDirective, init_shared_esm_bundler, watchEffect, createBaseVNode, withDirectives, normalizeStyle, inject, _overRest_default, _overArg_default, isArguments_default, isBuffer_default, ElTooltip, identity_default, _isPrototype_default, keys_default, isTypedArray_default, ClickOutside, ElCheckbox, ElScrollbar, _baseIteratee_default, useFormSize, debounce_default, _setToString_default, isArrayLike_default, yn, useDelayedToggle, _Uint8Array_default, _arrayLikeKeys_default, _baseFlatten_default, _Stack_default, get_default, useLocale, removeClass, useZIndex, throwError, addClass, isBoolean, isClient, useEventListener, _root_default, useSizeProp, getProp, debugWarn, isUndefined, isNumber, _arrayMap_default, _baseGetTag_default, eq_default, isArray_default, isObject_default, useNamespace, useResizeObserver, _baseAssignValue_default, isFunction_default, isElement, _assignValue_default, _isIndex_default, isObjectLike_default, hasClass, arrow_up_default, arrow_right_default, withInstall, _export_sfc, arrow_down_default, withNoopInstall, ElIcon, loading_default, objectCreate, baseCreate, _baseCreate_default, _copyArray_default, _copyObject_default, _baseRest_default, _isIterateeCall_default, _createAssigner_default, _nativeKeysIn_default, hasOwnProperty$1, _baseKeysIn_default, keysIn_default, getPrototype, _getPrototype_default, objectTag, funcProto, objectProto, funcToString, hasOwnProperty, objectCtorString, isPlainObject_default, freeExports, freeModule, Buffer, allocUnsafe, _cloneBuffer_default, _cloneArrayBuffer_default, _cloneTypedArray_default, _initCloneObject_default, _createBaseFor_default, baseFor, _baseFor_default, _baseForOwn_default, _createBaseEach_default, baseEach, _baseEach_default, _assignMergeValue_default, isArrayLikeObject_default, _safeGet_default, toPlainObject_default, _baseMergeDeep_default, _baseMerge_default, _baseMap_default, map_default, flatMap_default, merge, merge_default, rAF, v, o, f, s, u, d, N, l, p, m, w, D, x, E, M, F, _, A, c, h$1, X, b, O, I, P, Y, mousewheel, Mousewheel, require_escape_html, import_escape_html, getCell, orderBy, getColumnById, getColumnByKey, getColumnByCell, getRowIdentity, getKeysMap, removePopper, isFixedColumn, getFixedColumnsClass, getFixedColumnOffset, ensurePosition, sortData, doFlattenColumns, InitialStateMap, TableLayout, ElCheckboxGroup, _sfc_main$1, _hoisted_1$1, _hoisted_2$1, _hoisted_3, FilterPanel, TABLE_INJECTION_KEY, getAllColumns, convertToRows, TableHeader, defaultProps$2, TableBody, TableFooter, defaultProps$1, useScrollbar, tableIdSeed, _sfc_main, _hoisted_1, _hoisted_2, Table, defaultClassNames, cellStarts, getDefaultClassName, cellForced, defaultProps, columnIdSeed, ElTableColumn, ElTable, ElTableColumn$1;
    //#endregion
    ...
    */
    function baseMergeDeep(object, source, key, srcIndex, mergeFunc, customizer, stack) {
      var objValue = _safeGet_default(object, key),
        srcValue = _safeGet_default(source, key),
      ...
      if (isCommon) {
        ...
        if (isArr || isBuff || isTyped) {
          if (isArray_default(objValue)) newValue = objValue;else if (isArrayLikeObject_default(objValue)) newValue = _copyArray_default(objValue);else if (isBuff) {
            isCommon = false;
          ...
          newValue = objValue;
          if (isArguments_default(objValue)) newValue = toPlainObject_default(objValue);else if (!isObject_default(objValue) || isFunction_default(objValue)) newValue = _initCloneObject_default(srcValue);
        } else isCommon = false;
      }
      if (isCommon) {
    ...
    */
    function baseMerge(object, source, srcIndex, customizer, stack) {
      ...
      _baseFor_default(source, function (srcValue, key) {
        ...
        if (isObject_default(srcValue)) _baseMergeDeep_default(object, source, key, srcIndex, baseMerge, customizer, stack);else {
    ...
    */
    ...
    //#endregion
    //#region ../../../node_modules/.pnpm/lodash-es@4.17.21/node_modules/lodash-es/flatMap.js
    /**
    ...
    */
    ...
    function parseHeight(height) {
      ...
      if (typeof height === "string") if (/^\d+(?:px)?$/.test(height)) return Number.parseInt(height, 10);else return height;
      return null;
    }
    ...
    function toggleRowStatus(statusArr, row, newVal) {
      ...
      const toggleStatus = type => {
        if (type === "add") statusArr.push(row);else statusArr.splice(index, 1);
        changed = true;
      ...
      if (isBoolean(newVal)) {
        if (newVal && !included) toggleStatus("add");else if (!newVal && included) toggleStatus("remove");
    ...
    function createTablePopper(parentNode, trigger, popperContent, nextZIndex, tooltipOptions) {
      ...
      function renderContent() {
        ...
        content2.className = [`${ns}-popper`, isLight ? "is-light" : "is-dark", tooltipOptions.popperClass || ""].join(" ");
    ...
    function getCurrentColumns(column) {
      if (column.children) return flatMap_default(column.children, getCurrentColumns);else return [column];
    }
    ...
    //#endregion
    //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/store/expand.mjs
    function useExpand(watcherData) {
      ...
      const updateExpandRows = () => {
        ...
        if (defaultExpandAll.value) expandRows.value = data.slice();else if (rowKey) {
    ...
    //#endregion
    //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/store/current.mjs
    function useCurrent(watcherData) {
      ...
      const updateCurrentRowData = () => {
        ...
        if (!data.includes(oldCurrentRow) && oldCurrentRow) {
          if (rowKey) setCurrentRowByKey(getRowIdentity(oldCurrentRow, rowKey));else currentRow.value = null;
    ...
    //#endregion
    //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/store/tree.mjs
    function useTree(watcherData) {
        ...
        if (keys.length) {
          ...
          const getExpanded = (oldValue, key) => {
            if (ifChangeExpandRowKeys) {
              if (expandRowKeys.value) return ifExpandAll || expandRowKeys.value.includes(key);else return !!(ifExpandAll || (oldValue == null ? void 0 : oldValue.expanded));
            } else {
      ...
      const loadOrToggle = row => {
        ...
        if (lazy.value && data && "loaded" in data && !data.loaded) loadData(row, id, data);else toggleTreeExpansion(row, void 0);
      };
    ...
    //#endregion
    //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/store/watcher.mjs
    ...
    function useWatcher$1() {
      ...
      const scheduleLayout = (needUpdateColumns, immediate = false) => {
        ...
        if (immediate) instance.state.doLayout();else instance.state.debouncedUpdateLayout();
      };
      ...
      const updateAllSelected = () => {
        ...
        const isSelected2 = function (row) {
          if (selectedMap) return !!selectedMap[getRowIdentity(row, rowKey.value)];else return selection.value.includes(row);
        };
      ...
      const toggleRowExpansionAdapter = (row, expanded) => {
        if (columns.value.some(({
          type
        }) => type === "expand")) toggleRowExpansion(row, expanded);else toggleTreeExpansion(row, expanded);
      };
      return {
        assertRowKey,
        updateColumns,
    ...
    //#endregion
    //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/store/index.mjs
    function replaceColumn(array, column) {
      return array.map(item => {
        var _a;
        if (item.id === column.id) return column;else if ((_a = item.children) == null ? void 0 : _a.length) item.children = replaceColumn(item.children, column);
        return item;
      });
    }
    ...
    function useStore() {
      ...
      const mutations = {
        setData(states, data) {
          ...
          } else if (dataInstanceChanged) instance.store.clearSelection();else instance.store.cleanSelection();
      ...
      const commit = function (name, ...args) {
        ...
        if (mutations2[name]) mutations2[name].apply(instance, [instance.store.states].concat(args));else throw new Error(`Action not found: ${name}`);
      };
    ...
    //#endregion
    //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/store/helper.mjs
    ...
    //#endregion
    //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/table-layout.mjs
    ...
    function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return openBlock(), createBlock(_component_el_tooltip, {
        ...
        content: withCtx(() => [_ctx.multiple ? (openBlock(), createElementBlock("div", _hoisted_1$1, [createBaseVNode("div", {
          ...
          _: 1
        }, 8, ["wrap-class"])], 2), createBaseVNode("div", {
    ...
    //#endregion
    //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/layout-observer.mjs
    ...
    //#endregion
    //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/tokens.mjs

    //#endregion
    //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/table-header/event-helper.mjs
    function useEvent(props, emit) {
      ...
      const handleHeaderClick = (event, column) => {
        if (!column.filters && column.sortable) handleSortClick(event, column, false);else if (column.filterable && !column.sortable) handleFilterClick(event);
      ...
      const handleSortClick = (event, column, givenOrder) => {
        ...
        if (!order) sortOrder = column.order = null;else sortOrder = column.order = order;
    ...
    //#endregion
    //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/table-header/style.helper.mjs
    function useStyle$2(props) {
      ...
      const getHeaderRowClass = rowIndex => {
        ...
        if (typeof headerRowClassName === "string") classes.push(headerRowClassName);else if (typeof headerRowClassName === "function") classes.push(headerRowClassName.call(null, {
          rowIndex
        }));
        return classes.join(" ");
      };
      ...
      const getHeaderCellClass = (rowIndex, columnIndex, row, column) => {
        ...
        if (typeof headerCellClassName === "string") classes.push(headerCellClassName);else if (typeof headerCellClassName === "function") classes.push(headerCellClassName.call(null, {
          rowIndex,
          columnIndex,
          row,
          column
    ...
    //#endregion
    //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/table-header/utils-helper.mjs
    ...
    //#endregion
    //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/table-header/index.mjs

    //#endregion
    //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/table-body/events-helper.mjs
    ...
    //#endregion
    //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/table-body/styles-helper.mjs
    function useStyles(props) {
      ...
      const getRowClass = (row, rowIndex) => {
        ...
        if (typeof rowClassName === "string") classes.push(rowClassName);else if (typeof rowClassName === "function") classes.push(rowClassName.call(null, {
          row,
          rowIndex
        }));
        return classes;
      ...
      const getCellClass = (rowIndex, columnIndex, row, column, offset) => {
        ...
        if (typeof cellClassName === "string") classes.push(cellClassName);else if (typeof cellClassName === "function") classes.push(cellClassName.call(null, {
          rowIndex,
          columnIndex,
          row,
          column
    ...
    //#endregion
    //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/table-body/render-helper.mjs
    function useRender$1(props) {
      ...
      const rowRender = (row, $index, treeRowData, expanded = false) => {
        ...
        return h("tr", {
          ...
          const mergedTooltipOptions = column.showOverflowTooltip && merge_default({
    ...
    //#endregion
    //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/table-body/defaults.mjs

    //#endregion
    //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/table-footer/mapState-helper.mjs
    ...
    //#endregion
    //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/table-footer/style-helper.mjs
    ...
    //#endregion
    //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/table-footer/index.mjs

    //#endregion
    //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/table/utils-helper.mjs
    ...
    //#endregion
    //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/table/style-helper.mjs
    function useStyle(props, layout, store, table) {
      ...
      const syncPosition = function () {
        ...
        if (scrollLeft >= scrollWidth - offsetWidth - 1) setScrollClass("is-scrolling-right");else if (scrollLeft === 0) setScrollClass("is-scrolling-left");else setScrollClass("is-scrolling-middle");
      };
      const bindEvents = () => {
        if (!table.refs.scrollBarRef) return;
        if (table.refs.scrollBarRef.wrapRef) useEventListener(table.refs.scrollBarRef.wrapRef, "scroll", syncPosition, {
          passive: true
        });
        if (props.fit) useResizeObserver(table.vnode.el, resizeListener);else useEventListener(window, "resize", resizeListener);
      ...
      const scrollbarStyle = computed(() => {
        ...
        if (props.maxHeight) if (!Number.isNaN(Number(props.maxHeight))) return {
    ...
    //#endregion
    //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/table/key-render-helper.mjs
    ...
    //#endregion
    //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/table/defaults.mjs

    //#endregion
    //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/h-helper.mjs
    ...
    function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      }, [createBaseVNode("div", _hoisted_2, [renderSlot(_ctx.$slots, "default")], 512), _ctx.showHeader && _ctx.tableLayout === "fixed" ? withDirectives((openBlock(), createElementBlock("div", {
        key: 0,
        ref: "headerWrapper",
      ...
      }, null, 8, ["border", "default-sort", "store", "onSetDragVisible"])], 6)], 2)), [[_directive_mousewheel, _ctx.handleHeaderFooterMousewheel]]) : createCommentVNode("v-if", true), createBaseVNode("div", {
        ref: "bodyWrapper",
      ...
      }, null, 2)) : createCommentVNode("v-if", true)], 6), withDirectives(createBaseVNode("div", {
        ref: "resizeProxy",
    ...
    function treeCellPrefix({
      ...
      if (!treeNode) {
        if (createPlaceholder) return [h("span", {
    ...
    //#endregion
    //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/table-column/watcher-helper.mjs
    ...
    function useWatcher(owner, props_) {
      ...
      const registerNormalWatchers = () => {
        const props = ["label", "filters", "filterMultiple", "filteredValue", "sortable", "index", "formatter", "className", "labelClassName", "showOverflowTooltip"];
        const aliases = {
          property: "prop",
          align: "realAlign",
    ...
    //#endregion
    //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/table-column/render-helper.mjs
    function useRender(props, slots, owner) {
      ...
      const checkSubColumn = children => {
        if (Array.isArray(children)) children.forEach(child => check(child));else check(children);
        function check(item) {
          var _a;
      ...
      const setColumnRenders = column => {
        if (props.renderHeader) debugWarn("TableColumn", "Comparing to render-header, scoped-slot header is easier to use. We recommend users to use scoped-slot header.");else if (column.type !== "selection") column.renderHeader = scope => {
    ...
    //#endregion
    //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/table-column/defaults.mjs
    return {
      setters: [function (_chunkLegacy001Js) {
        __toESM = _chunkLegacy001Js.o;
        __commonJS = _chunkLegacy001Js.t;
      }, function (_vueRuntimeEsmBundlerLegacy003Js) {
        onUpdated = _vueRuntimeEsmBundlerLegacy003Js.$;
        ...
        Comment = _vueRuntimeEsmBundlerLegacy003Js.g;
        ...
        _overRest_default = _srcLegacy007Js.An;
        _overArg_default = _srcLegacy007Js.Cn;
        isArguments_default = _srcLegacy007Js.Dn;
        isBuffer_default = _srcLegacy007Js.En;
        ElTooltip = _srcLegacy007Js.Gt;
        identity_default = _srcLegacy007Js.Mn;
        _isPrototype_default = _srcLegacy007Js.On;
        keys_default = _srcLegacy007Js.Sn;
        isTypedArray_default = _srcLegacy007Js.Tn;
        ClickOutside = _srcLegacy007Js.Ut;
        ElCheckbox = _srcLegacy007Js.Vt;
        ElScrollbar = _srcLegacy007Js.Yt;
        _baseIteratee_default = _srcLegacy007Js._n;
        useFormSize = _srcLegacy007Js.en;
        debounce_default = _srcLegacy007Js.gn;
        _setToString_default = _srcLegacy007Js.jn;
        isArrayLike_default = _srcLegacy007Js.kn;
        yn = _srcLegacy007Js.rn;
        useDelayedToggle = _srcLegacy007Js.tn;
        _Uint8Array_default = _srcLegacy007Js.vn;
        _arrayLikeKeys_default = _srcLegacy007Js.wn;
        _baseFlatten_default = _srcLegacy007Js.xn;
        _Stack_default = _srcLegacy007Js.yn;
      }, function (_truncateLegacy00hJs) {
        get_default = _truncateLegacy00hJs.$;
        ...
        isClient = _truncateLegacy00hJs.Mt;
        useEventListener = _truncateLegacy00hJs.Ot;
        _root_default = _truncateLegacy00hJs.St;
        useSizeProp = _truncateLegacy00hJs.T;
        getProp = _truncateLegacy00hJs.U;
        debugWarn = _truncateLegacy00hJs.V;
        isUndefined = _truncateLegacy00hJs.X;
        isNumber = _truncateLegacy00hJs.Y;
        _arrayMap_default = _truncateLegacy00hJs._t;
        _baseGetTag_default = _truncateLegacy00hJs.bt;
        eq_default = _truncateLegacy00hJs.ct;
        isArray_default = _truncateLegacy00hJs.gt;
        isObject_default = _truncateLegacy00hJs.ht;
        useNamespace = _truncateLegacy00hJs.k;
        useResizeObserver = _truncateLegacy00hJs.kt;
        _baseAssignValue_default = _truncateLegacy00hJs.lt;
        isFunction_default = _truncateLegacy00hJs.mt;
        isElement = _truncateLegacy00hJs.q;
        _assignValue_default = _truncateLegacy00hJs.st;
        _isIndex_default = _truncateLegacy00hJs.ut;
        isObjectLike_default = _truncateLegacy00hJs.yt;
        ...
        loading_default = _iconLegacy00lJs.w;
      }],
      execute: function () {
        ...
        */
        ...
        keysIn_default = keysIn; //#endregion
        ...
        _getPrototype_default = getPrototype; //#endregion
        ...
        isPlainObject_default = isPlainObject; //#endregion
        ...
        _createBaseFor_default = createBaseFor; //#endregion
        ...
        */
        ...
        _createBaseEach_default = createBaseEach; //#endregion
        ...
        */
        ...
        _baseMap_default = baseMap;
        map_default = map;
        flatMap_default = flatMap; //#endregion
        ...
        * // => { 'a': [{ 'b': 2, 'c': 3 }, { 'd': 4, 'e': 5 }] }
        */
        merge = _createAssigner_default(function (object, source, srcIndex) {
          _baseMerge_default(object, source, srcIndex);
        });
        merge_default = merge; //#endregion
        //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/utils/raf.mjs
        rAF = fn => isClient ? window.requestAnimationFrame(fn) : setTimeout(fn, 16); //#endregion
        ...
        c = !!(typeof window < "u" && window.document && window.document.createElement), h$1 = {
          canUseDOM: c,
        ...
        */
        //#endregion
        //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/directives/mousewheel/index.mjs
        ...
        require_escape_html = /* @__PURE__ */__commonJS({
        ...
        //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/util.mjs
        ...
        orderBy = function (array, sortKey, reverse, sortMethod, sortBy) {
          if (!sortKey && !sortMethod && (!sortBy || Array.isArray(sortBy) && !sortBy.length)) return array;
          if (typeof reverse === "string") reverse = reverse === "descending" ? -1 : 1;else reverse = reverse && reverse < 0 ? -1 : 1;
          const getKey = sortMethod ? null : function (value, index) {
            if (sortBy) {
              if (!Array.isArray(sortBy)) sortBy = [sortBy];
              return sortBy.map(by => {
                if (typeof by === "string") return get_default(value, by);else return by(value, index, array);
              });
            }
            if (sortKey !== "$key") {
        ...
        getColumnById = function (table, columnId) {
          let column = null;
        ...
        getColumnByKey = function (table, columnKey) {
          let column = null;
        ...
        getColumnByCell = function (table, cell, namespace) {
        ...
        getKeysMap = function (array, rowKey) {
          const arrayMap = {};
        ...
        isFixedColumn = (index, fixed, store, realColumns) => {
          ...
          switch (fixed) {
            ...
            case "right":
              ...
              break;
            default:
              if (after < store.states.fixedLeafColumnsLength.value) fixedLayout = "left";else if (start >= columns.length - store.states.rightFixedLeafColumnsLength.value) fixedLayout = "right";
          }
          return fixedLayout ? {
        ...
        getFixedColumnsClass = (namespace, index, fixed, store, realColumns, offset = 0) => {
          const classes = [];
          const {
            direction,
            start,
          ...
          if (direction) {
            ...
            if (isLeft && after + offset === store.states.fixedLeafColumnsLength.value - 1) classes.push("is-last-column");else if (!isLeft && start - offset === store.states.columns.value.length - store.states.rightFixedLeafColumnsLength.value) classes.push("is-first-column");
          }
          return classes;
        };
        getFixedColumnOffset = (index, fixed, store, realColumns) => {
          const {
            direction,
            start = 0,
            after = 0
          ...
          const isLeft = direction === "left";
          const columns = store.states.columns.value;
          if (isLeft) styles.left = columns.slice(0, start).reduce(getOffset, 0);else styles.right = columns.slice(after + 1).reverse().reduce(getOffset, 0);
          return styles;
        };
        ensurePosition = (style, key) => {
          if (!style) return;
          if (!Number.isNaN(style[key])) style[key] = `${style[key]}px`;
        };
        init_shared_esm_bundler();
        sortData = (data, states) => {
          const sortingColumn = states.sortingColumn;
          if (!sortingColumn || typeof sortingColumn.sortable === "string") return data;
          return orderBy(data, states.sortProp, states.sortOrder, sortingColumn.sortMethod, sortingColumn.sortBy);
        };
        doFlattenColumns = columns => {
          const result = [];
          columns.forEach(column => {
            if (column.children && column.children.length > 0) result.push.apply(result, doFlattenColumns(column.children));else result.push(column);
          });
          return result;
        };
        InitialStateMap = {
        ...
        TableLayout = class {
          constructor(options) {
            ...
            this.gutterWidth = 0;
            for (const name in options) if (hasOwn(options, name)) if (isRef(this[name])) this[name].value = options[name];else this[name] = options[name];
          ...
          getFlattenColumns() {
            ...
            this.table.store.states.columns.value.forEach(column => {
              if (column.isColumnGroup) flattenColumns.push.apply(flattenColumns, column.columns);else flattenColumns.push(column);
            });
          ...
          updateColumnsWidth() {
            ...
            if (flexColumns.length > 0 && fit) {
              ...
              if (bodyMinWidth <= bodyWidth) {
                ...
                if (flexColumns.length === 1) flexColumns[0].realWidth = Number(flexColumns[0].minWidth || 80) + totalFlexWidth;else {
              ...
              flattenColumns.forEach(column => {
                if (!column.width && !column.minWidth) column.realWidth = 80;else column.realWidth = Number(column.width || column.minWidth);
        ...
        //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/filter-panel.mjs
        ({
        ...
        _sfc_main$1 = defineComponent({
          ...
          setup(props) {
            ...
            const filterValue = computed({
              ...
              set: value => {
                if (filteredValue.value) if (typeof value !== "undefined" && value !== null) filteredValue.value.splice(0, 1, value);else filteredValue.value.splice(0, 1);
              }
            });
            ...
            const handleSelect = _filterValue => {
              ...
              if (typeof _filterValue !== "undefined" && _filterValue !== null) confirmFilter(filteredValue.value);else confirmFilter([]);
              hidden();
            };
        ...
        _hoisted_2$1 = ["disabled"];
        _hoisted_3 = ["label", "onClick"];
        FilterPanel = /* @__PURE__ */_export_sfc(_sfc_main$1, [["render", _sfc_render$1], ["__file", "/home/runner/work/element-plus/element-plus/packages/components/table/src/filter-panel.vue"]]);
        TABLE_INJECTION_KEY = Symbol("ElTable");
        ...
        convertToRows = originColumns => {
          ...
          getAllColumns(originColumns).forEach(column => {
            if (!column.children) column.rowSpan = maxLevel - column.level + 1;else {
              column.rowSpan = 1;
        ...
        //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/table-body/index.mjs
        TableBody = defineComponent({
          name: "ElTableBody",
          ...
          render() {
            ...
            return h("tbody", {
              tabIndex: -1
            }, [(store.states.data.value || []).reduce((acc, row) => {
              return acc.concat(wrappedRowRender(row, acc.length));
            }, [])]);
          }
        });
        TableFooter = defineComponent({
          name: "ElTableFooter",
          props: {
            fixed: {
              type: String,
          ...
          render() {
            ...
            if (summaryMethod) sums = summaryMethod({
              ...
              if (!notNumber) sums[index] = values.reduce((prev, curr) => {
                ...
                if (!Number.isNaN(+value)) return Number.parseFloat((prev + curr).toFixed(Math.min(precision, 20)));else return prev;
              }, 0);else sums[index] = "";
            });
        ...
        //#endregion
        //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/composables/use-scrollbar.mjs
        useScrollbar = () => {
        ...
        //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/table.mjs
        tableIdSeed = 1;
        ...
        _hoisted_1 = ["data-prefix"];
        _hoisted_2 = {
          ref: "hiddenColumns",
          class: "hidden-columns"
        };
        Table = /* @__PURE__ */_export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/home/runner/work/element-plus/element-plus/packages/components/table/src/table.vue"]]); //#endregion
        //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/config.mjs
        defaultClassNames = {
        ...
        cellForced = {
          ...
          index: {
            ...
            renderCell({
              ...
              if (typeof index === "number") i = $index + index;else if (typeof index === "function") i = index($index);
              return h("div", {}, [i]);
            },
            sortable: false
          },
        ...
        //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/src/table-column/index.mjs
        init_shared_esm_bundler();
        columnIdSeed = 1;
        ElTableColumn = defineComponent({
          ...
          setup(props, {
            ...
            onBeforeMount(() => {
              ...
              let column = getPropsData(["columnKey", "label", "className", "labelClassName", "type", "renderHeader", "formatter", "fixed", "resizable"], ["sortMethod", "sortBy", "sortOrders"], ["selectable", "reserveSelection"], ["filterMethod", "filters", "filterMultiple", "filterOpened", "filteredValue", "filterPlacement"]);
          ...
          render() {
            ...
            try {
              ...
              if (Array.isArray(renderDefault)) {
                for (const childNode of renderDefault) if (((_c = childNode.type) == null ? void 0 : _c.name) === "ElTableColumn" || childNode.shapeFlag & 2) children.push(childNode);else if (childNode.type === Fragment && Array.isArray(childNode.children)) childNode.children.forEach(vnode2 => {
        ...
        //#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_87815230ec1d292541fa9e3e306612e7/node_modules/element-plus/es/components/table/index.mjs
        _export("t", ElTable = withInstall(Table, {
          TableColumn: ElTableColumn
        }));
        _export("n", ElTableColumn$1 = withNoopInstall(ElTableColumn)); //#endregion
      }
    };
  });
})();