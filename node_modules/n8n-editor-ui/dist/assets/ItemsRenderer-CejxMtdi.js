...
import { C as computed, D as createElementBlock, E as createCommentVNode, Gt as unref, Ht as toRefs, I as guardReactiveProps, It as ref, M as createVNode, P as defineComponent, Pt as reactive, Q as onUnmounted, Sn as toDisplayString, T as createBlock, W as mergeProps, Z as onMounted, _ as Fragment, _n as normalizeClass, _t as watch, at as renderSlot, bt as withCtx, et as openBlock, h as withModifiers, it as renderList, j as createTextVNode, k as createSlots, n as Transition, p as vShow, st as resolveDirective, vn as normalizeProps, w as createBaseVNode, xt as withDirectives, yn as normalizeStyle } from "./vue.runtime.esm-bundler-DDuXT-9r.js";
import { gt as useI18n } from "./_MapCache-Dw6Llo22.js";
import { D as N8nNodeIcon_default, In as N8nText_default, Ln as N8nButton_default, O as N8nNodeCreatorNode_default, et as N8nLoading_default, vt as N8nTooltip_default, zn as N8nIcon_default } from "./src-DsaRShTK.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-BwBpWJRZ.js";
import { Ri as COMMUNITY_NODES_INSTALLATION_DOCS_URL, b as getNewNodePosition, bt as shouldShowCommunityNodeDetails, er as useUsersStore, gt as isNodePreviewKey, o as useWorkflowsStore, rt as useNodeTypesStore, t as useTelemetry, u as DEFAULT_NODE_SIZE, vt as removePreviewToken } from "./useTelemetry-DedEakwK.js";
import { $a as DEFAULT_SUBCATEGORY, On as WEBHOOK_NODE_TYPE, R as DRAG_EVENT_DATA_KEY, Ui as isCommunityPackageName, it as CREDENTIAL_ONLY_NODE_PREFIX, no as HITL_SUBCATEGORY } from "./constants-C5Tj3dXQ.js";
import { n as useNodeType } from "./usePinnedData-BsuIBj2b.js";
import { d as useViewStacks, f as useKeyboardNavigation, t as useNodeCreatorStore, v as require_camelCase } from "./nodeCreator.store-C1GkQ_2N.js";
...
var NodeItem_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const tag = computed(() => {
			if (props.nodeType.tag) return { text: props.nodeType.tag };
