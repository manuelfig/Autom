...
import { C as computed, D as createElementBlock, E as createCommentVNode, G as nextTick, Gt as unref, I as guardReactiveProps, It as ref, J as onBeforeUnmount, L as h, M as createVNode, P as defineComponent, Q as onUnmounted, Sn as toDisplayString, T as createBlock, U as mergeModels, Vt as toRef, W as mergeProps, Z as onMounted, _ as Fragment, _n as normalizeClass, _t as watch, at as renderSlot, b as Teleport, bt as withCtx, c as useCssModule, ct as resolveDynamicComponent, et as openBlock, ft as useModel, h as withModifiers, it as renderList, j as createTextVNode, k as createSlots, l as useCssVars, n as Transition, nt as provide, p as vShow, pt as useSlots, ut as useAttrs, vn as normalizeProps, vt as watchEffect, w as createBaseVNode, xt as withDirectives, y as Suspense, yn as normalizeStyle, z as inject } from "./vue.runtime.esm-bundler-DDuXT-9r.js";
import { _ as onKeyDown, _t as I18nT, gt as useI18n, it as useThrottleFn, ot as watchOnce, st as watchThrottled, y as onKeyUp } from "./_MapCache-Dw6Llo22.js";
import { In as N8nText_default, Ln as N8nButton_default, Tt as N8nIconButton_default, mt as N8nLink_default, rt as useDeviceSupport, tt as N8nActionDropdown_default, v as N8nSticky_default, vt as N8nTooltip_default, w as N8nPopover_default, zn as N8nIcon_default } from "./src-DsaRShTK.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-BwBpWJRZ.js";
import { b as useRouter, n as truncateBeforeLast, x as createEventBus, y as useRoute } from "./truncate-7XypoloM.js";
import { E as TitledList_default } from "./ParameterInputList-DTj_ngLA.js";
import { A as _sfc_main$1, B as useGetPointerPosition, Bo as useSettingsStore, Cr as useHistoryStore, D as PanelPosition, Dn as useSourceControlStore, E as NodeId, Ei as nodeViewEventBus, F as getBezierPath, G as isChatNode, I as getBoundsofRects, Io as v4_default, L as getConnectedEdges, M as _sfc_main$d, N as _sfc_main$f, Ni as useUIStore, O as Position, P as clamp, Qr as getTriggerNodeServiceName, R as getRectOfNodes, Sn as injectWorkflowState, Sr as CanvasNodeRenderType, T as MarkerType, V as useVueFlow, a as useNDVStore, br as CanvasConnectionMode, c as CONFIGURATION_NODE_RADIUS, f as GRID_SIZE, gr as isValidNodeConnectionType, j as _sfc_main$3, k as _sfc_main$4, m as calculateNodeSize, o as useWorkflowsStore, p as PUSH_NODES_OFFSET, rt as useNodeTypesStore, t as useTelemetry, u as DEFAULT_NODE_SIZE, vi as isPresent, w as updateViewportToContainNodes, xn as useNodeHelpers, xr as CanvasNodeDirtiness, y as getMousePosition, yn as environments_store_default, z as getSmoothStepPath } from "./useTelemetry-DedEakwK.js";
import { c as sanitizeHtml, n as useStyles, s as isOutsideSelected, t as useToast } from "./useToast-LQk5sJH0.js";
import { Ca as WAIT_INDEFINITELY, Cs as CanvasNodeKey, Di as isExecutable, Dn as WAIT_NODE_TYPE, Go as WORKFLOW_EXTRACTION_NAME_MODAL_KEY, I as CUSTOM_API_CALL_KEY, Lr as extractReferencesInNodeExpressions, Nr as buildAdjacencyList, Oi as isNodeWithWorkflowSelector, Pr as parseExtractableSubgraphSelection, Q as CHAT_TRIGGER_NODE_TYPE, So as EXPERIMENT_TEMPLATES_DATA_QUALITY_KEY, Ss as CanvasNodeHandleKey, Ta as require_isEqual, Ui as isCommunityPackageName, Us as CANVAS_EXECUTION_DATA_THROTTLE_DURATION, Yt as NOT_DUPLICATABLE_NODE_TYPES, _i as getNodeInputs, _r as getResourcePermissions, ea as NodeConnectionTypes, io as NODE_CREATOR_OPEN_SOURCES, mn as SIMULATE_TRIGGER_NODE_TYPE, mo as VIEWS, pa as EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, pn as SIMULATE_NODE_TYPE, ui as mapConnectionsByDestination, vi as getNodeOutputs, wi as getSubworkflowId, ws as ExpressionLocalResolveContextSymbol, xa as SEND_AND_WAIT_OPERATION, xn as STICKY_NODE_TYPE, xs as CanvasKey, xt as FORM_NODE_TYPE } from "./constants-C5Tj3dXQ.js";
import { t as useChatPanelStore } from "./chatPanel.store-BZOiAoXE.js";
import { a as useTemplatesDataQualityStore, i as trackTemplatesClick, n as TemplateClickSource, r as isExtraTemplateLinksExperimentEnabled, t as useTemplatesStore } from "./templates.store-Bt8tpLPx.js";
import { r as useNodeDirtiness, t as useRunWorkflow } from "./useRunWorkflow-BLqckUNU.js";
import { t as usePinnedData } from "./usePinnedData-BsuIBj2b.js";
import { c as mapLegacyEndpointsToCanvasConnectionPort, i as insertSpacersBetweenEndpoints, l as parseCanvasConnectionHandleString, n as checkOverlap, r as createCanvasConnectionHandleString, s as mapLegacyConnectionsToCanvasConnections, t as useNodeCreatorStore } from "./nodeCreator.store-C1GkQ_2N.js";
import { t as getNodeIconSource } from "./nodeIcon-ChI78z3o.js";
import { a as useLogsStore, i as useExperimentalNdvStore, t as useCanvasOperations } from "./useCanvasOperations-Cxgmc_7x.js";
import { t as NodeIcon_default } from "./NodeIcon-BYTrCZAx.js";
import { t as KeyboardShortcutTooltip_default } from "./KeyboardShortcutTooltip-qZ5YD2sD.js";
import { t as useTelemetryContext } from "./useTelemetryContext-DX-4dy5E.js";
import { t as NodeSettings_default } from "./NodeSettings-CPhr6Uu2.js";
import { t as useKeybindings } from "./useKeybindings-BeP-kiF_.js";
...
var _hoisted_3$9 = { key: 6 };
var _hoisted_4$2 = { key: 8 };
var CanvasNodeStatusIcons_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const { hasPinnedData, executionErrors, validationErrors, hasExecutionErrors, hasValidationErrors, executionStatus, executionWaiting, executionWaitingForNext, executionRunning, hasRunData, runDataIterations, isDisabled, render: render$5, isNotInstalledCommunityNode } = useCanvasNode();
		...
		return (_ctx, _cache) => {
			return unref(executionWaiting) || unref(executionStatus) === "waiting" ? (openBlock(), createElementBlock("div", _hoisted_1$17, [createBaseVNode("div", { class: normalizeClass([...commonClasses.value, unref($style).waiting]) }, [createVNode(unref(N8nTooltip_default), { placement: "bottom" }, {
				content: withCtx(() => [createBaseVNode("div", { textContent: toDisplayString(unref(executionWaiting)) }, null, 8, _hoisted_2$7)]),
...
var CanvasNodeToolbar_vue_vue_type_style_index_0_lang_module_default = {
	canvasNodeToolbar: "_canvasNodeToolbar_snt78_123",
	isExperimentalNdvActive: "_isExperimentalNdvActive_snt78_130",
	canvasNodeToolbarItems: "_canvasNodeToolbarItems_snt78_139",
	forceVisible: "_forceVisible_snt78_150",
	statusIcons: "_statusIcons_snt78_154"
};
...
var CanvasNodeDefault_vue_vue_type_style_index_0_lang_module_default = {
	...
	label: "_label_199fc_172",
	subtitle: "_subtitle_199fc_175",
	running: "_running_199fc_181",
	selected: "_selected_199fc_188",
	success: "_success_199fc_192",
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				createBaseVNode("div", { class: normalizeClass(_ctx.$style.option) }, [createBaseVNode("div", { class: normalizeClass([_ctx.$style.selectedButtonHighlight, { [_ctx.$style.highlighted]: unref(nodeCreatorStore).isCreateNodeActive }]) }, [createBaseVNode("button", {
					...
					color: "foreground-xdark",
					size: 40
				})], 34)], 2), createBaseVNode("p", { class: normalizeClass(_ctx.$style.label) }, toDisplayString(unref(i18n).baseText("nodeView.canvasAddButton.addFirstStep")), 3)], 2),
...
var CanvasHandleRectangle_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	__name: "CanvasHandleRectangle",
	props: { handleClasses: { default: void 0 } },
	setup(__props) {
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass([_ctx.$style.rectangle, _ctx.handleClasses]) }, null, 2);
		};
	}
});
var CanvasHandleRectangle_vue_vue_type_style_index_0_lang_module_default = { rectangle: "_rectangle_1o69r_123" };
var CanvasHandleRectangle_default = /* @__PURE__ */ __plugin_vue_export_helper_default(CanvasHandleRectangle_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": CanvasHandleRectangle_vue_vue_type_style_index_0_lang_module_default }]]);
...
var CanvasHandleMainInput_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(classes.value) }, [createBaseVNode("div", { class: normalizeClass([unref($style).label]) }, toDisplayString(unref(label$7)), 3), createVNode(CanvasHandleRectangle_default, { "handle-classes": handleClasses$3 })], 2);
		};
	}
});
...
var CanvasHandleDot_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass([_ctx.$style.dot, _ctx.handleClasses]) }, null, 2);
		};
	}
});
var CanvasHandleDot_vue_vue_type_style_index_0_lang_module_default = { dot: "_dot_mkl47_123" };
...
var CanvasHandlePlus_vue_vue_type_style_index_0_lang_module_default = {
	...
	right: "_right_1wtvd_128",
	bottom: "_bottom_1wtvd_131",
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(classes.value) }, [
				...
				createVNode(CanvasHandleDot_default, { "handle-classes": handleClasses$2 }),
...
var CanvasHandleMainOutput_vue_vue_type_style_index_0_lang_module_default = {
	handle: "_handle_ca2iu_123",
	connected: "_connected_ca2iu_129",
	label: "_label_ca2iu_129",
	required: "_required_ca2iu_143",
...
var CanvasHandleDiamond_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass([_ctx.$style.diamond, _ctx.handleClasses]) }, null, 2);
		};
	}
});
var CanvasHandleDiamond_vue_vue_type_style_index_0_lang_module_default = { diamond: "_diamond_pdek7_123" };
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(classes.value) }, [
				...
				createVNode(CanvasHandleDiamond_default, { "handle-classes": handleClasses$1 }),
...
var CanvasHandleNonMainInput_vue_vue_type_style_index_0_lang_module_default = {
	handle: "_handle_1q30k_123",
	label: "_label_1q30k_130",
	required: "_required_1q30k_144"
};
...
var CanvasHandleNonMainOutput_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(classes.value) }, [createBaseVNode("div", { class: normalizeClass(unref($style).label) }, toDisplayString(unref(label$7)), 3), createVNode(CanvasHandleDiamond_default, { "handle-classes": handleClasses })], 2);
		};
	}
});
var CanvasHandleNonMainOutput_vue_vue_type_style_index_0_lang_module_default = {
	handle: "_handle_1argj_123",
...
var CanvasConnectionLine_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const edgeColor = computed(() => {
			if (connectionType.value !== NodeConnectionTypes.Main) return "var(--node-type--supplemental--color)";
			else return "var(--color--foreground--shade-2)";
		});
...
var CanvasEdge_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		useCssVars((_ctx) => ({ "5e8a20b0": edgeStroke.value }));
		const emit = __emit;
		const props = __props;
		const data = toRef(props, "data");
		const $style = useCssModule();
		...
		const edgeColor = computed(() => {
			...
			else if (!isMainConnection.value) return "var(--node-type--supplemental--color)";
			else if (props.selected) return "var(--color--background--shade-2)";
			else return "var(--color--foreground--shade-2)";
		});
		const edgeStyle = computed(() => ({
			...props.style,
...
var Canvas_default = /* @__PURE__ */ __plugin_vue_export_helper_default(Canvas_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": Canvas_vue_vue_type_style_index_0_lang_module_default }], ["__scopeId", "data-v-726dbe6e"]]);
function useCanvasMapping({ nodes, connections, workflowObject }) {
	...
	function getConnectionData(connection) {
		...
		else if (runDataTotal > 0 && lastSourceTask?.executionStatus !== "canceled") status$1 = "success";
...
export { CanvasNode_default as a, ExperimentalCanvasNodeSettings_default as c, CanvasBackground_default as i, useWorkflowExtraction as l, Canvas_default as n, useContextMenuItems as o, CanvasEdge_default as r, useExpressionResolveCtx as s, useCanvasMapping as t, CanvasRunWorkflowButton_default as u };
