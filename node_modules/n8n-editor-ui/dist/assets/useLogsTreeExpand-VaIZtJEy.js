...
import { C as computed, D as createElementBlock, E as createCommentVNode, G as nextTick, Gt as unref, It as ref, M as createVNode, P as defineComponent, Sn as toDisplayString, T as createBlock, Vt as toRef, W as mergeProps, _ as Fragment, _n as normalizeClass, _t as watch, bt as withCtx, et as openBlock, h as withModifiers, it as renderList, j as createTextVNode, mt as useTemplateRef, w as createBaseVNode, yn as normalizeStyle, zt as shallowRef } from "./vue.runtime.esm-bundler-DDuXT-9r.js";
import { B as useVirtualList, _t as I18nT, gt as useI18n, it as useThrottleFn, z as useTimestamp } from "./_MapCache-Dw6Llo22.js";
import { In as N8nText_default, Ln as N8nButton_default, Tt as N8nIconButton_default, vt as N8nTooltip_default, zn as N8nIcon_default } from "./src-DsaRShTK.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-BwBpWJRZ.js";
import { b as useRouter, r as require_get } from "./truncate-7XypoloM.js";
import { G as isChatNode, H as addTokenUsageData, Io as v4_default, Rt as require_upperFirst, Sn as injectWorkflowState, U as emptyTokenUsageData, W as formatTokenUsageCount, ci as parse, o as useWorkflowsStore, rt as useNodeTypesStore, vc as TOOL_EXECUTOR_NODE_NAME, xn as useNodeHelpers } from "./useTelemetry-DedEakwK.js";
import { t as useToast } from "./useToast-LQk5sJH0.js";
import { Fr as Workflow, Ir as parseErrorMetadata, It as MANUAL_CHAT_TRIGGER_NODE_TYPE, Ks as LOGS_EXECUTION_DATA_THROTTLE_DURATION, Q as CHAT_TRIGGER_NODE_TYPE, ea as NodeConnectionTypes, ia as AGENT_LANGCHAIN_NODE_TYPE, s as PLACEHOLDER_EMPTY_WORKFLOW_ID } from "./constants-C5Tj3dXQ.js";
import { t as useRunWorkflow } from "./useRunWorkflow-BLqckUNU.js";
import { t as NodeIcon_default } from "./NodeIcon-BYTrCZAx.js";
import { t as require_isEmpty } from "./isEmpty-Dg0afC99.js";
...
var LogsOverviewRows_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		async function handleTriggerPartialExecution(treeNode) {
			...
			if (latestName) await runWorkflow.runWorkflow({ destinationNode: latestName });
		}
