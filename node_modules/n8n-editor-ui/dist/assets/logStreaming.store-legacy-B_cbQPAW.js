...
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./useTelemetry-legacy-Bu_8SoSm.js"], function (_export, _context) {
    ...
    var ref, deleteDestinationFromDb, sendTestMessageToDestination, getEventNamesFromBackend, hasDestinationId, saveDestinationToDb, useRootStore, getDestinationsFromBackend, defineStore, eventGroupFromEventName, prettifyEventName, eventGroupsFromStringList, useLogStreamingStore;
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ref = _vueRuntimeEsmBundlerLegacy003Js.It;
      }, function (_useTelemetryLegacy00FJs) {
        deleteDestinationFromDb = _useTelemetryLegacy00FJs.As;
        sendTestMessageToDestination = _useTelemetryLegacy00FJs.Fs;
        getEventNamesFromBackend = _useTelemetryLegacy00FJs.Ms;
        hasDestinationId = _useTelemetryLegacy00FJs.Ns;
        saveDestinationToDb = _useTelemetryLegacy00FJs.Ps;
        useRootStore = _useTelemetryLegacy00FJs.Qs;
        getDestinationsFromBackend = _useTelemetryLegacy00FJs.js;
