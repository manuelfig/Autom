...
import { Bo as useSettingsStore, Cc as STORES, Ht as useCredentialsStore, er as useUsersStore, i as usePostHog, o as useWorkflowsStore, t as useTelemetry, xc as defineStore } from "./useTelemetry-DedEakwK.js";
import { t as useToast } from "./useToast-LQk5sJH0.js";
import { Hi as deepCopy, Ls as READY_TO_RUN_V2_PART2_EXPERIMENT, mo as VIEWS, ya as OPEN_AI_API_CREDENTIAL_TYPE } from "./constants-C5Tj3dXQ.js";
...
var LOCAL_STORAGE_CREDENTIAL_KEY = "N8N_READY_TO_RUN_V2_OPENAI_CREDENTIAL_ID";
const useReadyToRunWorkflowsV2Store = defineStore(STORES.EXPERIMENT_READY_TO_RUN_WORKFLOWS_V2, () => {
	...
	const trackExecuteAiWorkflowSuccess = () => {
		const variant = getCurrentVariant();
		telemetry.track("User executed ready to run AI workflow successfully", { variant });
	};
...
export { useProjectPages as n, useReadyToRunWorkflowsV2Store as t };
