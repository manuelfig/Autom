...
import { Qs as useRootStore, Ss as updateLdapConfig, as as saveSamlConfig, bs as runLdapSync, ec as UserManagementAuthenticationMethod, es as getOidcConfig, is as saveOidcConfig, ns as getSamlMetadata, os as testSamlConfig, rs as initSSO, ss as toggleSamlConfig, ts as getSamlConfig, vs as getLdapConfig, xc as defineStore, xs as testLdapConnection, ys as getLdapSynchronizations } from "./useTelemetry-DedEakwK.js";
...
const useSSOStore = defineStore("sso", () => {
	...
	const toggleLoginEnabled = async (enabled) => await toggleSamlConfig(rootStore.restApiContext, { loginEnabled: enabled });
