...
import { $t as hasOwn, C as computed, D as createElementBlock, E as createCommentVNode, G as nextTick, Gt as unref, It as ref, J as onBeforeUnmount, L as h, M as createVNode, P as defineComponent, Sn as toDisplayString, T as createBlock, Z as onMounted, _ as Fragment, _n as normalizeClass, _t as watch, at as renderSlot, bt as withCtx, c as useCssModule, en as hyphenate, et as openBlock, it as renderList, j as createTextVNode, mt as useTemplateRef, ot as resolveComponent, p as vShow, q as onBeforeMount, tn as init_shared_esm_bundler, w as createBaseVNode, xt as withDirectives, yn as normalizeStyle } from "./vue.runtime.esm-bundler-DDuXT-9r.js";
import { _t as I18nT, gt as useI18n, j as useLocalStorage, w as useDocumentVisibility } from "./_MapCache-Dw6Llo22.js";
import { Bt as ElTag, C as N8nPopoverReka_default, Ct as N8nInput_default, Ln as N8nButton_default, Tt as N8nIconButton_default, Y as N8nInputLabel_default, _ as SuggestedActions_default, a as N8nInlineTextEdit_default, f as N8nUserStack_default, it as N8nBadge_default, mt as N8nLink_default, tt as N8nActionDropdown_default, vt as N8nTooltip_default, x as N8nRadioButtons_default, zn as N8nIcon_default } from "./src-DsaRShTK.js";
import "./en-BYTsM8fR.js";
import { t as __vitePreload } from "./preload-helper-CR0ecmWK.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-BwBpWJRZ.js";
import { b as useRouter, x as createEventBus, y as useRoute } from "./truncate-7XypoloM.js";
...
import { Bo as useSettingsStore, Cc as STORES, Dn as useSourceControlStore, Ei as nodeViewEventBus, En as useProjectsStore, Gn as hasPermission, Ir as ResourceType, Ni as useUIStore, On as ProjectTypes, Qs as useRootStore, Tn as useDocumentTitle, Wi as PROJECT_MOVE_RESOURCE_MODAL, _n as useTagsStore, a as useNDVStore, at as useEvaluationStore, er as useUsersStore, mn as useWorkflowHelpers, o as useWorkflowsStore, rt as useNodeTypesStore, t as useTelemetry, xc as defineStore } from "./useTelemetry-DedEakwK.js";
import { i as getBannerRowHeight, t as useToast } from "./useToast-LQk5sJH0.js";
import "./sanitize-html-Cfxibw1n.js";
import "./path-browserify-CTmc1OxV.js";
import { Hs as EnterpriseEditionFeature, Jo as WORKFLOW_SHARE_MODAL_KEY, No as MODAL_CONFIRM, Oo as IMPORT_WORKFLOW_URL_MODAL_KEY, T as TIME_SAVED_DOCS_URL, Uo as WORKFLOW_ACTIVE_MODAL_KEY, Xs as TIME, _ as EVALUATIONS_DOCS_URL, _r as getResourcePermissions, a as MAX_WORKFLOW_NAME_LENGTH, dc as WORKFLOW_MENU_ACTIONS, g as ERROR_WORKFLOW_DOCS_URL, mo as VIEWS, po as MAIN_HEADER_TABS, qo as WORKFLOW_SETTINGS_MODAL_KEY, rs as LOCAL_STORAGE_HIDE_GITHUB_STAR_BUTTON, s as PLACEHOLDER_EMPTY_WORKFLOW_ID, wa as WEBHOOK_NODE_TYPE, xn as STICKY_NODE_TYPE, xo as DUPLICATE_MODAL_KEY, y as N8N_MAIN_GITHUB_REPO_URL } from "./constants-C5Tj3dXQ.js";
import "./merge-Dnkh07HW.js";
import "./assistant.store-BtplYeLr.js";
import "./dateformat-D7TIhVd4.js";
import { n as require_debounce, t as useDebounce } from "./useDebounce-DFa0sFlC.js";
...
import { i as usePushConnectionStore } from "./useRunWorkflow-BLqckUNU.js";
...
import { t as useFoldersStore } from "./folders.store-CmYx4Y_F.js";
import "./KeyboardShortcutTooltip-qZ5YD2sD.js";
import "./versions.store-Bon8LCsf.js";
import { t as usePageRedirectionHelper } from "./usePageRedirectionHelper-C8YGBi-F.js";
import { t as useBannersStore } from "./banners.store-DikUBA5o.js";
import "./ProjectIcon-CHk5fa0e.js";
import "./schemaPreview.store-DoyPeLof.js";
import { t as require_FileSaver_min } from "./FileSaver.min-DaytN8ae.js";
import { t as EnterpriseEdition_ee_default } from "./EnterpriseEdition.ee-Dmuvy1Qj.js";
import { t as SaveButton_default } from "./SaveButton-CtUWsjwd.js";
import "./TagsDropdown-sf5rCG4m.js";
import { t as WorkflowTagsDropdown_default } from "./WorkflowTagsDropdown-DTUxLHbz.js";
import { n as MCP_DOCS_PAGE_URL } from "./mcp.constants-BCNosk1p.js";
import { t as useMcp } from "./useMcp-CXTbPxKj.js";
import "./useWorkflowActivate-BSpG7MxI.js";
import "./ProjectBreadcrumb-ClcStQiI.js";
import { n as FolderBreadcrumbs_default, t as WorkflowActivator_default } from "./WorkflowActivator-DcgoNwmT.js";
import { t as useBeforeUnload } from "./useBeforeUnload-Dk9osL_V.js";
import { t as PushConnectionTracker_default } from "./PushConnectionTracker-DFq8UG-S.js";
import { t as useWorkflowSettingsCache } from "./useWorkflowsCache-B4y-W-2Y.js";
import { t as usePushConnection } from "./usePushConnection-cXyYzGoP.js";
import "./readyToRunWorkflows.store-BXoUeVNE.js";
import "./readyToRunWorkflowsV2.store-BJAu2HwR.js";
...
var WorkflowDescriptionPopover_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		watch(descriptionValue, (newValue) => {
			if ((newValue ?? "").trim() !== normalizedLastSaved.value) uiStore.stateIsDirty = true;
			else uiStore.stateIsDirty = false;
		});
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(N8nTooltip_default), {
				...
				default: withCtx(() => [createBaseVNode("div", {
					...
					content: withCtx(() => [createBaseVNode("div", {
						...
						_: 1
					}, 8, ["label", "tooltip-text"])], 2), createBaseVNode("footer", { class: normalizeClass(_ctx.$style["popover-footer"]) }, [createVNode(unref(N8nButton_default), {
...
const active = "_active_wp41v_128";
var WorkflowDescriptionPopover_vue_vue_type_style_index_0_lang_module_default = {
...
var WorkflowDescriptionPopover_default = /* @__PURE__ */ __plugin_vue_export_helper_default(WorkflowDescriptionPopover_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": WorkflowDescriptionPopover_vue_vue_type_style_index_0_lang_module_default }]]);
var _hoisted_1 = {
	class: "tags",
...
var WorkflowDetails_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		function getWorkflowId() {
			let id = void 0;
			if (props.id !== "__EMPTY__") id = props.id;
			else if (route.params.name && route.params.name !== "new") id = route.params.name;
			return id;
		}
		...
		async function onWorkflowMenuSelect(action) {
			switch (action) {
				...
				case WORKFLOW_MENU_ACTIONS.CHANGE_OWNER: {
					...
					changeOwnerEventBus.once("resource-moved", async () => await router.push({ name: VIEWS.WORKFLOWS }));
					uiStore.openModalWithData({
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(unref($style).container) }, [
				...
				}, null, 8, ["workflow-id", "workflow-description"])) : createCommentVNode("", true)], 2)]),
				createVNode(PushConnectionTracker_default, { class: "actions" }, {
					default: withCtx(() => [
						!isNewWorkflow.value ? (openBlock(), createBlock(WorkflowProductionChecklist_default, {
							key: 0,
							workflow: unref(workflowsStore).workflow
						}, null, 8, ["workflow"])) : createCommentVNode("", true),
						createBaseVNode("span", { class: normalizeClass(`activator ${unref($style).group}`) }, [createVNode(WorkflowActivator_default, {
						...
						createVNode(EnterpriseEdition_ee_default, { features: [unref(EnterpriseEditionFeature).Sharing] }, {
							...
							default: withCtx(() => [createBaseVNode("div", { class: normalizeClass(unref($style).group) }, [!isNewWorkflow.value ? (openBlock(), createBlock(CollaborationPane_default, { key: 0 })) : createCommentVNode("", true), createVNode(unref(N8nButton_default), {
								type: "secondary",
						...
						createBaseVNode("div", { class: normalizeClass(unref($style).group) }, [createVNode(SaveButton_default, {
							type: "primary",
						...
						createBaseVNode("div", { class: normalizeClass([unref($style).workflowMenuContainer, unref($style).group]) }, [createBaseVNode("input", {
...
const container$1 = "_container_177kb_123";
const group = "_group_177kb_138";
const hiddenInput = "_hiddenInput_177kb_143";
const deleteItem = "_deleteItem_177kb_147";
const disabledShareButton = "_disabledShareButton_177kb_151";
const closeNodeViewDiscovery = "_closeNodeViewDiscovery_177kb_155";
...
var WorkflowDetails_default = /* @__PURE__ */ __plugin_vue_export_helper_default(WorkflowDetails_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": WorkflowDetails_vue_vue_type_style_index_1_lang_module_default }], ["__scopeId", "data-v-efdec302"]]);
