...
import { C as computed, D as createElementBlock, E as createCommentVNode, Gt as unref, It as ref, L as h, M as createVNode, P as defineComponent, Sn as toDisplayString, T as createBlock, Z as onMounted, _ as Fragment, _n as normalizeClass, at as renderSlot, bt as withCtx, et as openBlock, h as withModifiers, it as renderList, j as createTextVNode, ot as resolveComponent, q as onBeforeMount, vt as watchEffect, w as createBaseVNode } from "./vue.runtime.esm-bundler-DDuXT-9r.js";
import { _t as I18nT, gt as useI18n } from "./_MapCache-Dw6Llo22.js";
import { $ as N8nActionToggle_default, Ln as N8nButton_default, Pn as N8nHeading_default, et as N8nLoading_default, it as N8nBadge_default, vt as N8nTooltip_default, zn as N8nIcon_default } from "./src-DsaRShTK.js";
...
import { Bo as useSettingsStore, Ho as getWorkflowVersion, Ni as useUIStore, Po as getNewWorkflow, Qs as useRootStore, Vo as getWorkflowHistory, o as useWorkflowsStore, r as telemetry, xc as defineStore } from "./useTelemetry-DedEakwK.js";
import { t as useToast } from "./useToast-LQk5sJH0.js";
import "./sanitize-html-Cfxibw1n.js";
import "./path-browserify-CTmc1OxV.js";
import { Ko as WORKFLOW_HISTORY_VERSION_RESTORE, _r as getResourcePermissions, mo as VIEWS } from "./constants-C5Tj3dXQ.js";
...
import { t as WorkflowPreview_default } from "./WorkflowPreview-q32aqNwB.js";
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("ul", {
				...
				}, [createBaseVNode("span", null, toDisplayString(unref(i18n).baseText("workflowHistory.limit", { interpolate: { evaluatedPruneTime: String(props.evaluatedPruneTime) } })), 1), createVNode(unref(I18nT), {
