;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./_MapCache-legacy-DcX1vy0l.js", "./useTelemetry-legacy-Bu_8SoSm.js", "./constants-legacy-CLA25gM9.js", "./useExternalHooks-legacy-DAJrb39U.js", "./nodeCreator.store-legacy-CjrGX9Lm.js"], function (_export, _context) {
    "use strict";

    var computed, useI18n, transformNodeType, injectWorkflowState, useCanvasStore, useWorkflowsStore, useNodeTypesStore, sortNodeCreateElements, OPEN_AI_NODE_TYPE, AI_CATEGORY_LANGUAGE_MODELS, MANUAL_TRIGGER_NODE_TYPE, WEBHOOK_NODE_TYPE, CHAT_TRIGGER_NODE_TYPE, OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE, AGENT_NODE_TYPE, BASIC_CHAIN_NODE_TYPE, NO_OP_NODE_TYPE, OPEN_AI_ASSISTANT_NODE_TYPE, SPLIT_IN_BATCHES_NODE_TYPE, CHAIN_LLM_LANGCHAIN_NODE_TYPE, TRIGGER_NODE_CREATOR_VIEW, NodeConnectionTypes, QA_CHAIN_NODE_TYPE, NODE_CREATOR_OPEN_SOURCES, SCHEDULE_TRIGGER_NODE_TYPE, STICKY_NODE_TYPE, useExternalHooks, useNodeCreatorStore, useActions;
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        AGENT_NODE_TYPE = _constantsLegacy00NJs.W;
        BASIC_CHAIN_NODE_TYPE = _constantsLegacy00NJs.X;
        NO_OP_NODE_TYPE = _constantsLegacy00NJs.Xt;
        OPEN_AI_ASSISTANT_NODE_TYPE = _constantsLegacy00NJs.Zt;
        SPLIT_IN_BATCHES_NODE_TYPE = _constantsLegacy00NJs._n;
        CHAIN_LLM_LANGCHAIN_NODE_TYPE = _constantsLegacy00NJs.ca;
        TRIGGER_NODE_CREATOR_VIEW = _constantsLegacy00NJs.do;
        NodeConnectionTypes = _constantsLegacy00NJs.ea;
        QA_CHAIN_NODE_TYPE = _constantsLegacy00NJs.in;
      ...
      execute: function () {
        ...
        _export("t", useActions = () => {
          const workflowState = injectWorkflowState();
          const nodeCreatorStore = useNodeCreatorStore();
          const nodeTypesStore = useNodeTypesStore();
          const i18n = useI18n();
          const singleNodeOpenSources = [NODE_CREATOR_OPEN_SOURCES.PLUS_ENDPOINT, NODE_CREATOR_OPEN_SOURCES.NODE_CONNECTION_ACTION, NODE_CREATOR_OPEN_SOURCES.NODE_CONNECTION_DROP];
          ...
          */
          ...
          function shouldPrependChatTrigger(addedNodes) {
            const COMPATIBLE_CHAT_NODES = [QA_CHAIN_NODE_TYPE, AGENT_NODE_TYPE, BASIC_CHAIN_NODE_TYPE, OPEN_AI_ASSISTANT_NODE_TYPE, OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE];
          ...
          function setAddedNodeActionParameters(action, telemetry, rootView = "") {
            const {
              $onAction: onWorkflowStoreAction
            } = useWorkflowsStore();
